...
namespace IntrinsicsLib {
    ...
    public static class Vector128s {
        ...
        /// <summary>
        /// Creates a new <see cref="Vector128{T}"/> instance with all elements initialized to the specified value.
        /// </summary>
        /// <typeparam name="T">The vector element type. T can be any primitive numeric type.</typeparam>
        /// <param name="value">The value that all elements will be initialized to.</param>
        /// <returns>A new <see cref="Vector128{T}"/> with all elements initialized to value.</returns>
        ...
        /// <summary>
        /// Creates a new <see cref="Vector128{T}"/> from a given array.
        /// </summary>
        /// <typeparam name="T">The vector element type. T can be any primitive numeric type.</typeparam>
        /// <param name="values">The values to add to the vector, as an array of objects of type <typeparamref name="T"/>.</param>
        /// <returns>A new <see cref="Vector128{T}"/> with its elements set to the first Count elements from <paramref name="values"/>.</returns>
        /// <seealso cref="Vector128{T}(T[])"/>
        ...
        /// <summary>
        /// Creates a new <see cref="Vector128{T}"/> from a given array starting at a specified index position.
        /// </summary>
        /// <typeparam name="T">The vector element type. T can be any primitive numeric type.</typeparam>
        /// <param name="values">The values to add to the vector, as an array of objects of type <typeparamref name="T"/>.</param>
        ...
        /// <summary>
        /// Creates a new <see cref="Vector128{T}"/> from a given read-only span of bytes.
        /// </summary>
        /// <typeparam name="T">The vector element type. T can be any primitive numeric type.</typeparam>
        ...
        /// <summary>
        /// Creates a new <see cref="Vector128{T}"/> from a from the given <see cref="ReadOnlySpan{T}"/>.
        /// </summary>
        /// <typeparam name="T">The vector element type. T can be any primitive numeric type.</typeparam>
        ...
        /// <summary>
        /// Creates a new <see cref="Vector128{T}"/> from a from the given <see cref="Span{T}"/>.
        /// </summary>
        /// <typeparam name="T">The vector element type. T can be any primitive numeric type.</typeparam>
        ...
        /// <summary>
        /// Rotate creates a new <see cref="Vector128{T}"/> from a given array starting at a specified index position.
        /// </summary>
        /// <typeparam name="T">The vector element type. T can be any primitive numeric type.</typeparam>
        /// <param name="values">The values to add to the vector, as an array of objects of type <typeparamref name="T"/>.</param>
        /// <param name="index">The starting index position from which to create the vector.</param>
        ...
        public static Vector128<T> CreateRotate<T>(T[] values, int index, int length) where T : struct {
            ...
            Vector128<T> rt = Create(arr);
            return rt;
        }

        /// <summary>
        /// Rotate creates a new <see cref="Vector128{T}"/> from a given array.
        /// </summary>
        /// <typeparam name="T">The vector element type. T can be any primitive numeric type.</typeparam>
        /// <param name="values">The values to add to the vector, as an array of objects of type <typeparamref name="T"/>.</param>
        /// <returns>A new <see cref="Vector128{T}"/> with its elements set to the first Count elements from <paramref name="values"/>.</returns>
        ...
        /// <summary>
        /// Creates a new <see cref="Vector128{T}"/> from a from the given <see cref="Func{T, TResult}"/>.
        /// </summary>
        /// <typeparam name="T">The vector element type. T can be any primitive numeric type.</typeparam>
        /// <param name="func">A function that gets the value of each element. Prototype: `T func(int index)`, `index` is element index.</param>
        /// <returns>A new <see cref="Vector128{T}"/> from a from the given <see cref="Func{T, TResult}"/>.</returns>
        ...
        /// <summary>
        /// Creates a new <see cref="Vector128{T}"/> from a from the given <see cref="Func{T1, T2, TResult}"/>.
        /// </summary>
        /// <typeparam name="T">The vector element type. T can be any primitive numeric type.</typeparam>
        ...
        /// <returns>A new <see cref="Vector128{T}"/> from a from the given <see cref="Func{T1, T2, TResult}"/>.</returns>
        ...
        /// <summary>
        /// Creates a <see cref="Vector128{T}"/> whose components are of a specified double type.
        /// </summary>
        ...
        /// <summary>
        /// Creates a <see cref="Vector128{T}"/> from double value `for` loop.
        /// </summary>
        /// <typeparam name="T">The vector element type. T can be any primitive numeric type.</typeparam>
        /// <param name="start">Start value.</param>
        /// <param name="step">Step value.</param>
        /// <returns>A new <see cref="Vector128{T}"/> from double value `for` loop.</returns>
        ...
        /// <summary>
        /// Creates a <see cref="Vector128{T}"/> whose components are of a specified bits.
        /// </summary>
        /// <param name="src">Source value.</param>
        /// <returns>A new <see cref="Vector128{T}"/> with all elements initialized to value.</returns>
        public static Vector128<T> CreateByBits<T>(Int64 src) where T : struct {
            return Create<T>(Scalars.GetByBits<T>(src));
        }
    ...
    /// </summary>
    /// <typeparam name="T">The vector element type. T can be any primitive numeric type.</typeparam>
    public static class Vector128s<T> where T : struct {
        // -- Number struct --
        ...
        static Vector128s() {
            ...
            SignMask = Vector128s.Create(ElementSignMask);
            ExponentMask = Vector128s.Create(ElementExponentMask);
            MantissaMask = Vector128s.Create(ElementMantissaMask);
            Epsilon = Vector128s.Create(ElementEpsilon);
            MaxValue = Vector128s.Create(ElementMaxValue);
            MinValue = Vector128s.Create(ElementMinValue);
            NaN = Vector128s.Create(ElementNaN);
            NegativeInfinity = Vector128s.Create(ElementNegativeInfinity);
            PositiveInfinity = Vector128s.Create(ElementPositiveInfinity);
            NonSignMask = Vector128s.OnesComplement(SignMask);
            NonExponentMask = Vector128s.OnesComplement(ExponentMask);
            NonMantissaMask = Vector128s.OnesComplement(MantissaMask);
            // -- Math --
            E = Vector128s.CreateByDouble<T>(Math.E);
            Pi = Vector128s.CreateByDouble<T>(Math.PI);
#if NET5_0_OR_GREATER
            Tau = Vector128s.CreateByDouble<T>(Math.Tau);
#else
        Tau = CreateByDouble(Math.PI * 2);
#endif // NET5_0_OR_GREATER
            // -- Math shift --
            // -- Specified value --
            AllBitsSet = Vector128s.OnesComplement(Vector128<T>.Zero);
            Serial = GetSerial();
            Demo = GetDemo();
            // -- Xyzw --
            if (true) {
            ...
            MaskBits1 = Vector128s.CreateByBits<T>(0x1);
            MaskBits2 = Vector128s.CreateByBits<T>(0x3);
            MaskBits4 = Vector128s.CreateByBits<T>(0xF);
            MaskBits8 = Vector128s.CreateByBits<T>(0xFF);
            MaskBits16 = Vector128s.CreateByBits<T>(0xFFFF);
            MaskBits32 = Vector128s.CreateByBits<T>(0xFFFFFFFF);
            // -- Positive number --
            V1 = Vector128s.CreateByDouble<T>(1);
            V2 = Vector128s.CreateByDouble<T>(2);
            V3 = Vector128s.CreateByDouble<T>(3);
            V4 = Vector128s.CreateByDouble<T>(4);
            V5 = Vector128s.CreateByDouble<T>(5);
            V6 = Vector128s.CreateByDouble<T>(6);
            V7 = Vector128s.CreateByDouble<T>(7);
            V8 = Vector128s.CreateByDouble<T>(8);
            V127 = Vector128s.CreateByDouble<T>(127);
            V255 = Vector128s.CreateByDouble<T>(255);
            V32767 = Vector128s.CreateByDouble<T>(32767);
            V65535 = Vector128s.CreateByDouble<T>(65535);
            V2147483647 = Vector128s.CreateByDouble<T>(2147483647);
            V4294967295 = Vector128s.CreateByDouble<T>(4294967295);
            // -- Negative number  --
            V_1 = Vector128s.CreateByDouble<T>(-1);
            V_2 = Vector128s.CreateByDouble<T>(-2);
            V_3 = Vector128s.CreateByDouble<T>(-3);
            V_4 = Vector128s.CreateByDouble<T>(-4);
            V_5 = Vector128s.CreateByDouble<T>(-5);
            V_6 = Vector128s.CreateByDouble<T>(-6);
            V_7 = Vector128s.CreateByDouble<T>(-7);
            V_8 = Vector128s.CreateByDouble<T>(-8);
            V_128 = Vector128s.CreateByDouble<T>(-128);
            V_32768 = Vector128s.CreateByDouble<T>(-32768);
            V_2147483648 = Vector128s.CreateByDouble<T>(-2147483648);
        }
        ...
        private static Vector128<T> GetSerial() {
            return Vector128s.CreateByDoubleLoop<T>(0, 1);
        }
