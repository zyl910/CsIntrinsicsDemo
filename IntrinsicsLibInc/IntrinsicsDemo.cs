...
#pragma warning restore SYSLIB0012 // Type or member is obsolete
        ...
        /// <param name="writer">Output <see cref="TextWriter"/>.</param>
        /// <param name="indent">The indent.</param>
        public static void RunCommon(TextWriter writer, string indent) {
            try {
                RunBaseInfo(writer, indent);
            } catch (Exception ex) {
                writer.WriteLine("RunBaseInfo fail! " + ex.ToString());
            }
            try {
                RunVectorStart(writer, indent);
            } catch (Exception ex) {
                writer.WriteLine("RunVectorStart fail! " + ex.ToString());
            }
        }
