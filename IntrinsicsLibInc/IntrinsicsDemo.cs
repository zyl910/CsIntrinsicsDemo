...
#pragma warning restore SYSLIB0012 // Type or member is obsolete
        ...
        public static void RunInfoScalars<T>(TextWriter tw, string indent) where T : struct {
            ...
            if (ShowFull) {
                ...
                WriteLine(tw, indent, "VMaxSByte:\t{0}", Scalars<T>.VMaxSByte);
                WriteLine(tw, indent, "VMaxByte:\t{0}", Scalars<T>.VMaxByte);
                WriteLine(tw, indent, "VMaxInt16:\t{0}", Scalars<T>.VMaxInt16);
                WriteLine(tw, indent, "VMaxUInt16:\t{0}", Scalars<T>.VMaxUInt16);
                WriteLine(tw, indent, "VMaxInt32:\t{0}", Scalars<T>.VMaxInt32);
                WriteLine(tw, indent, "VMaxUInt32:\t{0}", Scalars<T>.VMaxUInt32);
                WriteLine(tw, indent, "V_1:\t{0}", Scalars<T>.V_1);
                WriteLine(tw, indent, "VMinSByte:\t{0}", Scalars<T>.VMinSByte);
                WriteLine(tw, indent, "VMinInt16:\t{0}", Scalars<T>.VMinInt16);
                WriteLine(tw, indent, "VMinInt32:\t{0}", Scalars<T>.VMinInt32);
                WriteLine(tw, indent, "VReciprocalMaxSByte:\t{0}", Scalars<T>.VReciprocalMaxSByte);
                WriteLine(tw, indent, "VReciprocalMaxByte:\t{0}", Scalars<T>.VReciprocalMaxByte);
                WriteLine(tw, indent, "VReciprocalMaxInt16:\t{0}", Scalars<T>.VReciprocalMaxInt16);
                WriteLine(tw, indent, "VReciprocalMaxUInt16:\t{0}", Scalars<T>.VReciprocalMaxUInt16);
                WriteLine(tw, indent, "VReciprocalMaxInt32:\t{0}", Scalars<T>.VReciprocalMaxInt32);
                WriteLine(tw, indent, "VReciprocalMaxUInt32:\t{0}", Scalars<T>.VReciprocalMaxUInt32);
            }
        }
        ...
        public static void RunInfoVectors<T>(TextWriter tw, string indent) where T:struct {
            ...
            if (ShowFull) {
                ...
                WriteLine(tw, indent, "VMaxSByte:\t{0}", Vectors<T>.VMaxSByte);
                WriteLine(tw, indent, "VMaxByte:\t{0}", Vectors<T>.VMaxByte);
                WriteLine(tw, indent, "VMaxInt16:\t{0}", Vectors<T>.VMaxInt16);
                WriteLine(tw, indent, "VMaxUInt16:\t{0}", Vectors<T>.VMaxUInt16);
                WriteLine(tw, indent, "VMaxInt32:\t{0}", Vectors<T>.VMaxInt32);
                WriteLine(tw, indent, "VMaxUInt32:\t{0}", Vectors<T>.VMaxUInt32);
                WriteLine(tw, indent, "V_1:\t{0}", Vectors<T>.V_1);
                WriteLine(tw, indent, "VMinSByte:\t{0}", Vectors<T>.VMinSByte);
                WriteLine(tw, indent, "VMinInt16:\t{0}", Vectors<T>.VMinInt16);
                WriteLine(tw, indent, "VMinInt32:\t{0}", Vectors<T>.VMinInt32);
                WriteLine(tw, indent, "VReciprocalMaxSByte:\t{0}", Vectors<T>.VReciprocalMaxSByte);
                WriteLine(tw, indent, "VReciprocalMaxByte:\t{0}", Vectors<T>.VReciprocalMaxByte);
                WriteLine(tw, indent, "VReciprocalMaxInt16:\t{0}", Vectors<T>.VReciprocalMaxInt16);
                WriteLine(tw, indent, "VReciprocalMaxUInt16:\t{0}", Vectors<T>.VReciprocalMaxUInt16);
                WriteLine(tw, indent, "VReciprocalMaxInt32:\t{0}", Vectors<T>.VReciprocalMaxInt32);
                WriteLine(tw, indent, "VReciprocalMaxUInt32:\t{0}", Vectors<T>.VReciprocalMaxUInt32);
            }
            WriteLine(tw, indent, "Serial:\t{0}", Vectors<T>.Serial);
            WriteLine(tw, indent, "SerialDesc:\t{0}", Vectors<T>.SerialDesc);
        ...
        public static void RunInfoVector64s<T>(TextWriter tw, string indent) where T : struct {
            ...
            if (ShowFull) {
                ...
                WriteLine(tw, indent, "VMaxSByte:\t{0}", Vector64s<T>.VMaxSByte);
                WriteLine(tw, indent, "VMaxByte:\t{0}", Vector64s<T>.VMaxByte);
                WriteLine(tw, indent, "VMaxInt16:\t{0}", Vector64s<T>.VMaxInt16);
                WriteLine(tw, indent, "VMaxUInt16:\t{0}", Vector64s<T>.VMaxUInt16);
                WriteLine(tw, indent, "VMaxInt32:\t{0}", Vector64s<T>.VMaxInt32);
                WriteLine(tw, indent, "VMaxUInt32:\t{0}", Vector64s<T>.VMaxUInt32);
                WriteLine(tw, indent, "V_1:\t{0}", Vector64s<T>.V_1);
                WriteLine(tw, indent, "VMinSByte:\t{0}", Vector64s<T>.VMinSByte);
                WriteLine(tw, indent, "VMinInt16:\t{0}", Vector64s<T>.VMinInt16);
                WriteLine(tw, indent, "VMinInt32:\t{0}", Vector64s<T>.VMinInt32);
                WriteLine(tw, indent, "VReciprocalMaxSByte:\t{0}", Vector64s<T>.VReciprocalMaxSByte);
                WriteLine(tw, indent, "VReciprocalMaxByte:\t{0}", Vector64s<T>.VReciprocalMaxByte);
                WriteLine(tw, indent, "VReciprocalMaxInt16:\t{0}", Vector64s<T>.VReciprocalMaxInt16);
                WriteLine(tw, indent, "VReciprocalMaxUInt16:\t{0}", Vector64s<T>.VReciprocalMaxUInt16);
                WriteLine(tw, indent, "VReciprocalMaxInt32:\t{0}", Vector64s<T>.VReciprocalMaxInt32);
                WriteLine(tw, indent, "VReciprocalMaxUInt32:\t{0}", Vector64s<T>.VReciprocalMaxUInt32);
            }
            WriteLine(tw, indent, "Serial:\t{0}", Vector64s<T>.Serial);
            WriteLine(tw, indent, "SerialDesc:\t{0}", Vector64s<T>.SerialDesc);
        ...
        public static void RunInfoVector128s<T>(TextWriter tw, string indent) where T : struct {
            ...
            if (ShowFull) {
                ...
                WriteLine(tw, indent, "VMaxSByte:\t{0}", Vector128s<T>.VMaxSByte);
                WriteLine(tw, indent, "VMaxByte:\t{0}", Vector128s<T>.VMaxByte);
                WriteLine(tw, indent, "VMaxInt16:\t{0}", Vector128s<T>.VMaxInt16);
                WriteLine(tw, indent, "VMaxUInt16:\t{0}", Vector128s<T>.VMaxUInt16);
                WriteLine(tw, indent, "VMaxInt32:\t{0}", Vector128s<T>.VMaxInt32);
                WriteLine(tw, indent, "VMaxUInt32:\t{0}", Vector128s<T>.VMaxUInt32);
                WriteLine(tw, indent, "V_1:\t{0}", Vector128s<T>.V_1);
                WriteLine(tw, indent, "VMinSByte:\t{0}", Vector128s<T>.VMinSByte);
                WriteLine(tw, indent, "VMinInt16:\t{0}", Vector128s<T>.VMinInt16);
                WriteLine(tw, indent, "VMinInt32:\t{0}", Vector128s<T>.VMinInt32);
                WriteLine(tw, indent, "VReciprocalMaxSByte:\t{0}", Vector128s<T>.VReciprocalMaxSByte);
                WriteLine(tw, indent, "VReciprocalMaxByte:\t{0}", Vector128s<T>.VReciprocalMaxByte);
                WriteLine(tw, indent, "VReciprocalMaxInt16:\t{0}", Vector128s<T>.VReciprocalMaxInt16);
                WriteLine(tw, indent, "VReciprocalMaxUInt16:\t{0}", Vector128s<T>.VReciprocalMaxUInt16);
                WriteLine(tw, indent, "VReciprocalMaxInt32:\t{0}", Vector128s<T>.VReciprocalMaxInt32);
                WriteLine(tw, indent, "VReciprocalMaxUInt32:\t{0}", Vector128s<T>.VReciprocalMaxUInt32);
            }
            WriteLine(tw, indent, "Serial:\t{0}", Vector128s<T>.Serial);
            WriteLine(tw, indent, "SerialDesc:\t{0}", Vector128s<T>.SerialDesc);
        ...
        public static void RunInfoVector256s<T>(TextWriter tw, string indent) where T : struct {
            ...
            if (ShowFull) {
                ...
                WriteLine(tw, indent, "VMaxSByte:\t{0}", Vector256s<T>.VMaxSByte);
                WriteLine(tw, indent, "VMaxByte:\t{0}", Vector256s<T>.VMaxByte);
                WriteLine(tw, indent, "VMaxInt16:\t{0}", Vector256s<T>.VMaxInt16);
                WriteLine(tw, indent, "VMaxUInt16:\t{0}", Vector256s<T>.VMaxUInt16);
                WriteLine(tw, indent, "VMaxInt32:\t{0}", Vector256s<T>.VMaxInt32);
                WriteLine(tw, indent, "VMaxUInt32:\t{0}", Vector256s<T>.VMaxUInt32);
                WriteLine(tw, indent, "V_1:\t{0}", Vector256s<T>.V_1);
                WriteLine(tw, indent, "VMinSByte:\t{0}", Vector256s<T>.VMinSByte);
                WriteLine(tw, indent, "VMinInt16:\t{0}", Vector256s<T>.VMinInt16);
                WriteLine(tw, indent, "VMinInt32:\t{0}", Vector256s<T>.VMinInt32);
                WriteLine(tw, indent, "VReciprocalMaxSByte:\t{0}", Vector256s<T>.VReciprocalMaxSByte);
                WriteLine(tw, indent, "VReciprocalMaxByte:\t{0}", Vector256s<T>.VReciprocalMaxByte);
                WriteLine(tw, indent, "VReciprocalMaxInt16:\t{0}", Vector256s<T>.VReciprocalMaxInt16);
                WriteLine(tw, indent, "VReciprocalMaxUInt16:\t{0}", Vector256s<T>.VReciprocalMaxUInt16);
                WriteLine(tw, indent, "VReciprocalMaxInt32:\t{0}", Vector256s<T>.VReciprocalMaxInt32);
                WriteLine(tw, indent, "VReciprocalMaxUInt32:\t{0}", Vector256s<T>.VReciprocalMaxUInt32);
            }
            WriteLine(tw, indent, "Serial:\t{0}", Vector256s<T>.Serial);
            WriteLine(tw, indent, "SerialDesc:\t{0}", Vector256s<T>.SerialDesc);
