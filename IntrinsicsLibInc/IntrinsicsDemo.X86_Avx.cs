...
namespace IntrinsicsLib {
    partial class IntrinsicsDemo {
        ...
        public unsafe static void RunX86Avx(TextWriter tw, string indent) {
            ...
            WriteLine(tw, indent, "Add(Vector256s<Double>.Demo, Vector256s<Double>.V1):\t{0}", Avx.Add(Vector256s<Double>.Demo, Vector256s<Double>.V1));
            WriteLine(tw, indent, "Add(Vector256s<Double>.Demo, Vector256s<Double>.V2):\t{0}", Avx.Add(Vector256s<Double>.Demo, Vector256s<Double>.V2));
            WriteLine(tw, indent, "Add(Vector256s<Single>.Demo, Vector256s<Single>.V1):\t{0}", Avx.Add(Vector256s<Single>.Demo, Vector256s<Single>.V1));
            WriteLine(tw, indent, "Add(Vector256s<Single>.Demo, Vector256s<Single>.V2):\t{0}", Avx.Add(Vector256s<Single>.Demo, Vector256s<Single>.V2));
            ...
            // 	FI
            // ENDFOR
            WriteLine(tw, indent, "AddSubtract(Vector256s<Double>.Demo, Vector256s<Double>.V1):\t{0}", Avx.AddSubtract(Vector256s<Double>.Demo, Vector256s<Double>.V1));
            WriteLine(tw, indent, "AddSubtract(Vector256s<Double>.Demo, Vector256s<Double>.V2):\t{0}", Avx.AddSubtract(Vector256s<Double>.Demo, Vector256s<Double>.V2));
            WriteLine(tw, indent, "AddSubtract(Vector256s<Single>.Demo, Vector256s<Single>.V1):\t{0}", Avx.AddSubtract(Vector256s<Single>.Demo, Vector256s<Single>.V1));
            WriteLine(tw, indent, "AddSubtract(Vector256s<Single>.Demo, Vector256s<Single>.V2):\t{0}", Avx.AddSubtract(Vector256s<Single>.Demo, Vector256s<Single>.V2));
            ...
            WriteLine(tw, indent, "And(Vector256s<Double>.Demo, Vector256s<Double>.V1):\t{0}", Avx.And(Vector256s<Double>.Demo, Vector256s<Double>.V1));
            WriteLine(tw, indent, "And(Vector256s<Double>.Demo, Vector256s<Double>.V2):\t{0}", Avx.And(Vector256s<Double>.Demo, Vector256s<Double>.V2));
            WriteLine(tw, indent, "And(Vector256s<Single>.Demo, Vector256s<Single>.V1):\t{0}", Avx.And(Vector256s<Single>.Demo, Vector256s<Single>.V1));
            WriteLine(tw, indent, "And(Vector256s<Single>.Demo, Vector256s<Single>.V2):\t{0}", Avx.And(Vector256s<Single>.Demo, Vector256s<Single>.V2));
            ...
            WriteLine(tw, indent, "AndNot(Vector256s<Double>.Demo, Vector256s<Double>.V1):\t{0}", Avx.AndNot(Vector256s<Double>.Demo, Vector256s<Double>.V1));
            WriteLine(tw, indent, "AndNot(Vector256s<Double>.Demo, Vector256s<Double>.V2):\t{0}", Avx.AndNot(Vector256s<Double>.Demo, Vector256s<Double>.V2));
            WriteLine(tw, indent, "AndNot(Vector256s<Single>.Demo, Vector256s<Single>.V1):\t{0}", Avx.AndNot(Vector256s<Single>.Demo, Vector256s<Single>.V1));
            WriteLine(tw, indent, "AndNot(Vector256s<Single>.Demo, Vector256s<Single>.V2):\t{0}", Avx.AndNot(Vector256s<Single>.Demo, Vector256s<Single>.V2));
            ...
            foreach (byte control in new byte[] { 1, 3, 0xCB }) {
                WriteLine(tw, indent, "Blend - control={0} (0x{0:X}):", control);
                WriteLine(tw, indentNext, "Blend(Vector256s<Double>.Demo, Vector256s<Double>.V1, control):\t{0}", Avx.Blend(Vector256s<Double>.Demo, Vector256s<Double>.V1, control));
                //Debugger.Break();
                WriteLine(tw, indentNext, "Blend(Vector256s<Double>.Demo, Vector256s<Double>.V2, control):\t{0}", Avx.Blend(Vector256s<Double>.Demo, Vector256s<Double>.V2, control));
                WriteLine(tw, indentNext, "Blend(Vector256s<Single>.Demo, Vector256s<Single>.V1, control):\t{0}", Avx.Blend(Vector256s<Single>.Demo, Vector256s<Single>.V1, control));
                WriteLine(tw, indentNext, "Blend(Vector256s<Single>.Demo, Vector256s<Single>.V2, control):\t{0}", Avx.Blend(Vector256s<Single>.Demo, Vector256s<Single>.V2, control));
            }
            ...
            // 	FI
            // ENDFOR
            WriteLine(tw, indent, "BlendVariable(Vector256s<Double>.Demo, Vector256s<Double>.V1, Vector256s<Double>.Demo):\t{0}", Avx.BlendVariable(Vector256s<Double>.Demo, Vector256s<Double>.V1, Vector256s<Double>.Demo));
            WriteLine(tw, indent, "BlendVariable(Vector256s<Double>.Demo, Vector256s<Double>.V2, Vector256s<Double>.Demo):\t{0}", Avx.BlendVariable(Vector256s<Double>.Demo, Vector256s<Double>.V2, Vector256s<Double>.Demo));
            WriteLine(tw, indent, "BlendVariable(Vector256s<Single>.Demo, Vector256s<Single>.V1, Vector256s<Single>.Demo):\t{0}", Avx.BlendVariable(Vector256s<Single>.Demo, Vector256s<Single>.V1, Vector256s<Single>.Demo));
            WriteLine(tw, indent, "BlendVariable(Vector256s<Single>.Demo, Vector256s<Single>.V2, Vector256s<Single>.Demo):\t{0}", Avx.BlendVariable(Vector256s<Single>.Demo, Vector256s<Single>.V2, Vector256s<Single>.Demo));
            ...
            float f3 = 3.0f;
            double d3 = 3.0;
            WriteLine(tw, indent, "BroadcastScalarToVector128(&f3):\t{0}", Avx.BroadcastScalarToVector128(&f3));
            WriteLine(tw, indent, "BroadcastScalarToVector256(&f3):\t{0}", Avx.BroadcastScalarToVector256(&d3));
            WriteLine(tw, indent, "BroadcastScalarToVector256(&f3):\t{0}", Avx.BroadcastScalarToVector256(&f3));
            ...
            fixed (void* p = &Vector128s<Double>.Demo) {
                WriteLine(tw, indent, "BroadcastVector128ToVector256(&Vector128s<Double>.Demo):\t{0}", Avx.BroadcastVector128ToVector256((double*)p));
            }
            fixed (void* p = &Vector128s<Single>.Demo) {
                WriteLine(tw, indent, "BroadcastVector128ToVector256(&Vector128s<Single>.Demo):\t{0}", Avx.BroadcastVector128ToVector256((float*)p));
            }
            ...
            WriteLine(tw, indent, "Ceiling(Vector256s<Double>.Demo):\t{0}", Avx.Ceiling(Vector256s<Double>.Demo));
            WriteLine(tw, indent, "Ceiling(Vector256s<Single>.Demo):\t{0}", Avx.Ceiling(Vector256s<Single>.Demo));
            ...
            foreach (FloatComparisonMode mode in new FloatComparisonMode[] { FloatComparisonMode.OrderedEqualNonSignaling, FloatComparisonMode.OrderedLessThanSignaling, FloatComparisonMode.OrderedLessThanOrEqualSignaling }) {
                WriteLine(tw, indent, "Compare - mode={0} (0x{0:X}):", mode);
                WriteLine(tw, indentNext, "Compare(Vector128s<Double>.Demo, Vector128s<Double>.V0, mode):\t{0}", Avx.Compare(Vector128s<Double>.Demo, Vector128s<Double>.V0, mode));
                WriteLine(tw, indentNext, "Compare(Vector128s<Single>.Demo, Vector128s<Single>.V0, mode):\t{0}", Avx.Compare(Vector128s<Single>.Demo, Vector128s<Single>.V0, mode));
                WriteLine(tw, indentNext, "Compare(Vector256s<Double>.Demo, Vector256s<Double>.V0, mode):\t{0}", Avx.Compare(Vector256s<Double>.Demo, Vector256s<Double>.V0, mode));
                WriteLine(tw, indentNext, "Compare(Vector256s<Single>.Demo, Vector256s<Single>.V0, mode):\t{0}", Avx.Compare(Vector256s<Single>.Demo, Vector256s<Single>.V0, mode));
            }
            ...
            // The above native signature does not exist. We provide this additional overload for completeness.
            WriteLine(tw, indent, "CompareLessThan(Vector256s<Double>.Demo, Vector256s<Double>.V0):\t{0}", Avx.CompareLessThan(Vector256s<Double>.Demo, Vector256s<Double>.V0));
            WriteLine(tw, indent, "CompareLessThan(Vector256s<Single>.Demo, Vector256s<Single>.V0):\t{0}", Avx.CompareLessThan(Vector256s<Single>.Demo, Vector256s<Single>.V0));
            ...
            WriteLine(tw, indent, "ConvertToVector128Int32(Vector256s<Double>.Demo):\t{0}", Avx.ConvertToVector128Int32(Vector256s<Double>.Demo));
            WriteLine(tw, indent, "ConvertToVector128Int32WithTruncation(Vector256s<Double>.Demo):\t{0}", Avx.ConvertToVector128Int32WithTruncation(Vector256s<Double>.Demo));
            WriteLine(tw, indent, "ConvertToVector128Single(Vector256s<Double>.Demo):\t{0}", Avx.ConvertToVector128Single(Vector256s<Double>.Demo));
            WriteLine(tw, indent, "ConvertToVector256Double(Vector128s<Int32>.Demo):\t{0}", Avx.ConvertToVector256Double(Vector128s<Int32>.Demo));
            WriteLine(tw, indent, "ConvertToVector256Double(Vector128s<Single>.Demo):\t{0}", Avx.ConvertToVector256Double(Vector128s<Single>.Demo));
            ...
            WriteLine(tw, indent, "ConvertToVector256Int32(Vector128s<Single>.Demo):\t{0}", Avx.ConvertToVector256Int32(Vector256s<Single>.Demo));
            WriteLine(tw, indent, "ConvertToVector256Int32WithTruncation(Vector256s<Single>.Demo):\t{0}", Avx.ConvertToVector256Int32WithTruncation(Vector256s<Single>.Demo));
            WriteLine(tw, indent, "ConvertToVector256Single(Vector256s<Int32>.Demo):\t{0}", Avx.ConvertToVector256Single(Vector256s<Int32>.Demo));
            ...
            WriteLine(tw, indent, "Divide(Vector256s<Double>.Demo, Vector256s<Double>.V2):\t{0}", Avx.Divide(Vector256s<Double>.Demo, Vector256s<Double>.V2));
            WriteLine(tw, indent, "Divide(Vector256s<Single>.Demo, Vector256s<Single>.V2):\t{0}", Avx.Divide(Vector256s<Single>.Demo, Vector256s<Single>.V2));
            ...
            foreach (byte control in new byte[] { 0x81, 0xC1, 0x33 }) {
                WriteLine(tw, indent, "DotProduct - control={0} (0x{0:X}):", control);
                WriteLine(tw, indentNext, "DotProduct(Vector256s<Single>.Demo, Vector256s<Single>.V2, control):\t{0}", Avx.DotProduct(Vector256s<Single>.Demo, Vector256s<Single>.V2, control));
            }
            ...
            WriteLine(tw, indent, "DuplicateEvenIndexed(Vector256s<Double>.Demo):\t{0}", Avx.DuplicateEvenIndexed(Vector256s<Double>.Demo));
            WriteLine(tw, indent, "DuplicateEvenIndexed(Vector256s<Single>.Demo):\t{0}", Avx.DuplicateEvenIndexed(Vector256s<Single>.Demo));
            WriteLine(tw, indent, "DuplicateOddIndexed(Vector256s<Single>.Demo):\t{0}", Avx.DuplicateOddIndexed(Vector256s<Single>.Demo));
            ...
            foreach (byte idx in new byte[] { 0, 1 }) {
                WriteLine(tw, indent, "ExtractVector128 - idx={0} (0x{0:X}):", idx);
                WriteLine(tw, indentNext, "ExtractVector128(Vector256s<Int32>.Demo, idx):\t{0}", Avx.ExtractVector128(Vector256s<Int32>.Demo, idx));
                WriteLine(tw, indentNext, "ExtractVector128(Vector256s<Double>.Demo, idx):\t{0}", Avx.ExtractVector128(Vector256s<Double>.Demo, idx));
                WriteLine(tw, indentNext, "ExtractVector128(Vector256s<Single>.Demo, idx):\t{0}", Avx.ExtractVector128(Vector256s<Single>.Demo, idx));
            }
            ...
            // VROUNDPS ymm, ymm/m256, imm8(9)
            WriteLine(tw, indent, "Floor(Vector256s<Double>.Demo):\t{0}", Avx.Floor(Vector256s<Double>.Demo));
            WriteLine(tw, indent, "Floor(Vector256s<Single>.Demo):\t{0}", Avx.Floor(Vector256s<Single>.Demo));
            ...
            WriteLine(tw, indent, "HorizontalAdd(Vector256s<Double>.Demo, Vector256s<Double>.V2):\t{0}", Avx.HorizontalAdd(Vector256s<Double>.Demo, Vector256s<Double>.V2));
            WriteLine(tw, indent, "HorizontalAdd(Vector256s<Single>.Demo, Vector256s<Single>.V2):\t{0}", Avx.HorizontalAdd(Vector256s<Single>.Demo, Vector256s<Single>.V2));
            ...
            WriteLine(tw, indent, "HorizontalSubtract(Vector256s<Double>.Demo, Vector256s<Double>.V2):\t{0}", Avx.HorizontalSubtract(Vector256s<Double>.Demo, Vector256s<Double>.V2));
            WriteLine(tw, indent, "HorizontalSubtract(Vector256s<Single>.Demo, Vector256s<Single>.V2):\t{0}", Avx.HorizontalSubtract(Vector256s<Single>.Demo, Vector256s<Single>.V2));
            ...
            // ESAC
            foreach (byte idx in new byte[] { 0, 1 }) {
                WriteLine(tw, indent, "InsertVector128 - idx={0} (0x{0:X}):", idx);
                WriteLine(tw, indentNext, "InsertVector128(Vector256s<Int32>.Demo, Vector128s<Int32>.V2, idx):\t{0}", Avx.InsertVector128(Vector256s<Int32>.Demo, Vector128s<Int32>.V2, idx));
                WriteLine(tw, indentNext, "InsertVector128(Vector256s<Double>.Demo, Vector128s<Double>.V2, idx):\t{0}", Avx.InsertVector128(Vector256s<Double>.Demo, Vector128s<Double>.V2, idx));
                WriteLine(tw, indentNext, "InsertVector128(Vector256s<Single>.Demo, Vector128s<Single>.V2, idx):\t{0}", Avx.InsertVector128(Vector256s<Single>.Demo, Vector128s<Single>.V2, idx));
            }
            ...
            fixed (void* p = &Vector128s<Double>.V1) {
                WriteLine(tw, indent, "MaskLoad(&Vector128s<Double>.V1, Vector128s<Double>.Demo):\t{0}", Avx.MaskLoad((double*)p, Vector128s<Double>.Demo));
            }
            fixed (void* p = &Vector256s<Double>.V1) {
                WriteLine(tw, indent, "MaskLoad(&Vector256s<Double>.V1, Vector256s<Double>.Demo):\t{0}", Avx.MaskLoad((double*)p, Vector256s<Double>.Demo));
            }
            fixed (void* p = &Vector128s<Single>.V1) {
                WriteLine(tw, indent, "MaskLoad(&Vector128s<Single>.V1, Vector128s<Single>.Demo):\t{0}", Avx.MaskLoad((float*)p, Vector128s<Single>.Demo));
            }
            fixed (void* p = &Vector256s<Single>.V1) {
                WriteLine(tw, indent, "MaskLoad(&Vector256s<Single>.V1, Vector256s<Single>.Demo):\t{0}", Avx.MaskLoad((float*)p, Vector256s<Single>.Demo));
            }
            ...
            WriteLine(tw, indent, "MaskStore((double*)&srcS_128_double, Vector128s<Double>.Demo, Vector128s<Double>.V1):\t{0}", srcS_128_double);
            ...
            WriteLine(tw, indent, "MaskStore((double*)&srcS_256_double, Vector256s<Double>.Demo, Vector256s<Double>.V1):\t{0}", srcS_256_double);
            ...
            WriteLine(tw, indent, "MaskStore((float*)&srcS_128_float, Vector128s<Single>.Demo, Vector128s<Single>.V1):\t{0}", srcS_128_float);
            ...
            WriteLine(tw, indent, "MaskStore((float*)&srcS_256_float, Vector256s<Single>.Demo, Vector256s<Single>.V1):\t{0}", srcS_256_float);
            ...
            WriteLine(tw, indent, "Max(Vector256s<Double>.Demo, Vector256s<Double>.V2):\t{0}", Avx.Max(Vector256s<Double>.Demo, Vector256s<Double>.V2));
            WriteLine(tw, indent, "Max(Vector256s<Single>.Demo, Vector256s<Single>.V2):\t{0}", Avx.Max(Vector256s<Single>.Demo, Vector256s<Single>.V2));
            ...
            WriteLine(tw, indent, "Min(Vector256s<Double>.Demo, Vector256s<Double>.V2):\t{0}", Avx.Min(Vector256s<Double>.Demo, Vector256s<Double>.V2));
            WriteLine(tw, indent, "Min(Vector256s<Single>.Demo, Vector256s<Single>.V2):\t{0}", Avx.Min(Vector256s<Single>.Demo, Vector256s<Single>.V2));
            ...
            //ENDFOR
            //dst[MAX:8] := 0
            WriteLine(tw, indent, "MoveMask(Vector256s<Double>.Demo):\t{0}\t# 0x{0:X}", Avx.MoveMask(Vector256s<Double>.Demo));
            WriteLine(tw, indent, "MoveMask(Vector256s<Single>.Demo):\t{0}\t# 0x{0:X}", Avx.MoveMask(Vector256s<Single>.Demo));
            ...
            WriteLine(tw, indent, "Multiply(Vector256s<Double>.Demo, Vector256s<Double>.V2):\t{0}", Avx.Multiply(Vector256s<Double>.Demo, Vector256s<Double>.V2));
            WriteLine(tw, indent, "Multiply(Vector256s<Single>.Demo, Vector256s<Single>.V2):\t{0}", Avx.Multiply(Vector256s<Single>.Demo, Vector256s<Single>.V2));
            ...
            WriteLine(tw, indent, "Or(Vector256s<Double>.Demo, Vector256s<Double>.V2):\t{0}", Avx.Or(Vector256s<Double>.Demo, Vector256s<Double>.V2));
            WriteLine(tw, indent, "Or(Vector256s<Single>.Demo, Vector256s<Single>.V2):\t{0}", Avx.Or(Vector256s<Single>.Demo, Vector256s<Single>.V2));
            ...
            WriteLine(tw, indent, "Permute(Vector128s<Double>.Demo, 0b0000_0001):\t{0}", Avx.Permute(Vector128s<Double>.Demo, 0b0000_0001));
            WriteLine(tw, indent, "Permute(Vector128s<Single>.Demo, 0b0001_1011):\t{0}", Avx.Permute(Vector128s<Single>.Demo, 0b0001_1011));
            WriteLine(tw, indent, "Permute(Vector256s<Double>.Demo, 0b0000_0101):\t{0}", Avx.Permute(Vector256s<Double>.Demo, 0b0000_0101));
            WriteLine(tw, indent, "Permute(Vector256s<Single>.Demo, 0b0001_1011):\t{0}", Avx.Permute(Vector256s<Single>.Demo, 0b0001_1011));
            ...
            foreach (byte control in new byte[] { 0, 1, 2, 3, 0x23, 0xA3, 0x10 }) {
                WriteLine(tw, indent, "Permute2x128 - control={0} (0x{0:X}):", control);
                WriteLine(tw, indentNext, "Permute2x128(Vector256s<Int32>.Demo, Vector256s<Int32>.V2, control):\t{0}", Avx.Permute2x128(Vector256s<Int32>.Demo, Vector256s<Int32>.V2, control));
                WriteLine(tw, indentNext, "Permute2x128(Vector256s<Double>.Demo, Vector256s<Double>.V2, control):\t{0}", Avx.Permute2x128(Vector256s<Double>.Demo, Vector256s<Double>.V2, control));
                WriteLine(tw, indentNext, "Permute2x128(Vector256s<Single>.Demo, Vector256s<Single>.V2, control):\t{0}", Avx.Permute2x128(Vector256s<Single>.Demo, Vector256s<Single>.V2, control));
            }
            ...
            WriteLine(tw, indent, "PermuteVar(Vector128s<Double>.Demo, Vector128.Create(2L, 0L)):\t{0}", Avx.PermuteVar(Vector128s<Double>.Demo, Vector128.Create(2L, 0L)));
            WriteLine(tw, indent, "PermuteVar(Vector128s<Single>.Demo, Vector128.Create(3, 2, 1, 0)):\t{0}", Avx.PermuteVar(Vector128s<Single>.Demo, Vector128.Create(3, 2, 1, 0)));
            WriteLine(tw, indent, "PermuteVar(Vector256s<Double>.Demo, Vector256.Create(2L, 0L)):\t{0}", Avx.PermuteVar(Vector256s<Double>.Demo, Vector256.Create(2L, 0L, 2L, 0L)));
            WriteLine(tw, indent, "PermuteVar(Vector256s<Single>.Demo, Vector256.Create(3, 2, 1, 0)):\t{0}", Avx.PermuteVar(Vector256s<Single>.Demo, Vector256.Create(3, 2, 1, 0, 3, 2, 1, 0)));
            ...
            WriteLine(tw, indent, "Reciprocal(Vector256s<Single>.Demo):\t{0}", Avx.Reciprocal(Vector256s<Single>.Demo));
            ...
            // ENDFOR
            WriteLine(tw, indent, "ReciprocalSqrt(Vector256s<Single>.Demo):\t{0}", Avx.ReciprocalSqrt(Vector256s<Single>.Demo));
            ...
            WriteLine(tw, indent, "RoundCurrentDirection(Vector256s<Double>.Demo):\t{0}", Avx.RoundCurrentDirection(Vector256s<Double>.Demo));
            WriteLine(tw, indent, "RoundCurrentDirection(Vector256s<Single>.Demo):\t{0}", Avx.RoundCurrentDirection(Vector256s<Single>.Demo));
            WriteLine(tw, indent, "RoundCurrentDirection(Vector256s<Double>.Demo):\t{0}", Avx.RoundCurrentDirection(Vector256s<Double>.Demo));
            WriteLine(tw, indent, "RoundCurrentDirection(Vector256s<Single>.Demo):\t{0}", Avx.RoundCurrentDirection(Vector256s<Single>.Demo));
            WriteLine(tw, indent, "RoundToNearestInteger(Vector256s<Double>.Demo):\t{0}", Avx.RoundToNearestInteger(Vector256s<Double>.Demo));
            WriteLine(tw, indent, "RoundToNearestInteger(Vector256s<Single>.Demo):\t{0}", Avx.RoundToNearestInteger(Vector256s<Single>.Demo));
            WriteLine(tw, indent, "RoundToNegativeInfinity(Vector256s<Double>.Demo):\t{0}", Avx.RoundToNegativeInfinity(Vector256s<Double>.Demo));
            WriteLine(tw, indent, "RoundToNegativeInfinity(Vector256s<Single>.Demo):\t{0}", Avx.RoundToNegativeInfinity(Vector256s<Single>.Demo));
            WriteLine(tw, indent, "RoundToPositiveInfinity(Vector256s<Double>.Demo):\t{0}", Avx.RoundToPositiveInfinity(Vector256s<Double>.Demo));
            WriteLine(tw, indent, "RoundToPositiveInfinity(Vector256s<Single>.Demo):\t{0}", Avx.RoundToPositiveInfinity(Vector256s<Single>.Demo));
            WriteLine(tw, indent, "RoundToZero(Vector256s<Double>.Demo):\t{0}", Avx.RoundToZero(Vector256s<Double>.Demo));
            WriteLine(tw, indent, "RoundToZero(Vector256s<Single>.Demo):\t{0}", Avx.RoundToZero(Vector256s<Single>.Demo));
            ...
            WriteLine(tw, indent, "Shuffle(Vector256s<Double>.Demo):\t{0}", Avx.Shuffle(Vector256s<Double>.Demo, Vector256s<Double>.Demo, 0b0000_0101));
            WriteLine(tw, indent, "Shuffle(Vector256s<Single>.Demo):\t{0}", Avx.Shuffle(Vector256s<Single>.Demo, Vector256s<Single>.Demo, 0b0001_1011));
            ...
            WriteLine(tw, indent, "Sqrt(Vector256s<Double>.Demo):\t{0}", Avx.Sqrt(Vector256s<Double>.Demo));
            WriteLine(tw, indent, "Sqrt(Vector256s<Single>.Demo):\t{0}", Avx.Sqrt(Vector256s<Single>.Demo));
            ...
            WriteLine(tw, indent, "Subtract(Vector256s<Double>.Demo, Vector256s<Double>.V2):\t{0}", Avx.Subtract(Vector256s<Double>.Demo, Vector256s<Double>.V2));
            WriteLine(tw, indent, "Subtract(Vector256s<Single>.Demo, Vector256s<Single>.V2):\t{0}", Avx.Subtract(Vector256s<Single>.Demo, Vector256s<Single>.V2));
            ...
            // VPTEST ymm, ymm/m256
            WriteLine(tw, indent, "TestC(Vector256s<Double>.Demo, Vector256s<Double>.V2):\t{0}", Avx.TestC(Vector256s<Double>.Demo, Vector256s<Double>.V2));
            WriteLine(tw, indent, "TestC(Vector256s<Single>.Demo, Vector256s<Single>.V2):\t{0}", Avx.TestC(Vector256s<Single>.Demo, Vector256s<Single>.V2));
            ...
            // VPTEST ymm, ymm/m256
            WriteLine(tw, indent, "TestNotZAndNotC(Vector256s<Double>.Demo, Vector256s<Double>.V2):\t{0}", Avx.TestNotZAndNotC(Vector256s<Double>.Demo, Vector256s<Double>.V2));
            WriteLine(tw, indent, "TestNotZAndNotC(Vector256s<Single>.Demo, Vector256s<Single>.V2):\t{0}", Avx.TestNotZAndNotC(Vector256s<Single>.Demo, Vector256s<Single>.V2));
            ...
            // VPTEST ymm, ymm/m256
            WriteLine(tw, indent, "TestZ(Vector256s<Double>.Demo, Vector256s<Double>.V2):\t{0}", Avx.TestZ(Vector256s<Double>.Demo, Vector256s<Double>.V2));
            WriteLine(tw, indent, "TestZ(Vector256s<Single>.Demo, Vector256s<Single>.V2):\t{0}", Avx.TestZ(Vector256s<Single>.Demo, Vector256s<Single>.V2));
            ...
            // dst[MAX:256] := 0
            WriteLine(tw, indent, "UnpackHigh(Vector256s<Double>.Demo, Vector256s<Double>.V2):\t{0}", Avx.UnpackHigh(Vector256s<Double>.Demo, Vector256s<Double>.V2));
            WriteLine(tw, indent, "UnpackHigh(Vector256s<Single>.Demo, Vector256s<Single>.V2):\t{0}", Avx.UnpackHigh(Vector256s<Single>.Demo, Vector256s<Single>.V2));
            ...
            // dst[MAX:256] := 0
            WriteLine(tw, indent, "UnpackLow(Vector256s<Double>.Demo, Vector256s<Double>.V2):\t{0}", Avx.UnpackLow(Vector256s<Double>.Demo, Vector256s<Double>.V2));
            WriteLine(tw, indent, "UnpackLow(Vector256s<Single>.Demo, Vector256s<Single>.V2):\t{0}", Avx.UnpackLow(Vector256s<Single>.Demo, Vector256s<Single>.V2));
            ...
            // VXORPS ymm, ymm, ymm/m256
            WriteLine(tw, indent, "Xor(Vector256s<Double>.Demo, Vector256s<Double>.V2):\t{0}", Avx.Xor(Vector256s<Double>.Demo, Vector256s<Double>.V2));
            WriteLine(tw, indent, "Xor(Vector256s<Single>.Demo, Vector256s<Single>.V2):\t{0}", Avx.Xor(Vector256s<Single>.Demo, Vector256s<Single>.V2));
        }
        ...
        public unsafe static void RunX86Avx2(TextWriter tw, string indent) {
            ...
            // VPABSB ymm, ymm/m256
            WriteLine(tw, indent, "Abs(Vector256s<SByte>.Demo):\t{0}", Avx2.Abs(Vector256s<SByte>.Demo));
            WriteLine(tw, indent, "Abs(Vector256s<Int16>.Demo):\t{0}", Avx2.Abs(Vector256s<Int16>.Demo));
            WriteLine(tw, indent, "Abs(Vector256s<Int32>.Demo):\t{0}", Avx2.Abs(Vector256s<Int32>.Demo));
            ...
            // VPADDQ ymm, ymm, ymm/m256
            WriteLine(tw, indent, "Add(Vector256s<Byte>.Demo, Vector256s<Byte>.V2):\t{0}", Avx2.Add(Vector256s<Byte>.Demo, Vector256s<Byte>.V2));
            WriteLine(tw, indent, "Add(Vector256s<UInt16>.Demo, Vector256s<UInt16>.V2):\t{0}", Avx2.Add(Vector256s<UInt16>.Demo, Vector256s<UInt16>.V2));
            WriteLine(tw, indent, "Add(Vector256s<UInt32>.Demo, Vector256s<UInt32>.V2):\t{0}", Avx2.Add(Vector256s<UInt32>.Demo, Vector256s<UInt32>.V2));
            WriteLine(tw, indent, "Add(Vector256s<UInt64>.Demo, Vector256s<UInt64>.V2):\t{0}", Avx2.Add(Vector256s<UInt64>.Demo, Vector256s<UInt64>.V2));
            WriteLine(tw, indent, "Add(Vector256s<SByte>.Demo, Vector256s<SByte>.V2):\t{0}", Avx2.Add(Vector256s<SByte>.Demo, Vector256s<SByte>.V2));
            WriteLine(tw, indent, "Add(Vector256s<Int16>.Demo, Vector256s<Int16>.V2):\t{0}", Avx2.Add(Vector256s<Int16>.Demo, Vector256s<Int16>.V2));
            WriteLine(tw, indent, "Add(Vector256s<Int32>.Demo, Vector256s<Int32>.V2):\t{0}", Avx2.Add(Vector256s<Int32>.Demo, Vector256s<Int32>.V2));
            WriteLine(tw, indent, "Add(Vector256s<Int64>.Demo, Vector256s<Int64>.V2):\t{0}", Avx2.Add(Vector256s<Int64>.Demo, Vector256s<Int64>.V2));
            ...
            WriteLine(tw, indent, "AddSaturate(Vector256s<Byte>.Demo, Vector256s<Byte>.V2):\t{0}", Avx2.AddSaturate(Vector256s<Byte>.Demo, Vector256s<Byte>.V2));
            WriteLine(tw, indent, "AddSaturate(Vector256s<UInt16>.Demo, Vector256s<UInt16>.V2):\t{0}", Avx2.AddSaturate(Vector256s<UInt16>.Demo, Vector256s<UInt16>.V2));
            WriteLine(tw, indent, "AddSaturate(Vector256s<SByte>.Demo, Vector256s<SByte>.V2):\t{0}", Avx2.AddSaturate(Vector256s<SByte>.Demo, Vector256s<SByte>.V2));
            WriteLine(tw, indent, "AddSaturate(Vector256s<Int16>.Demo, Vector256s<Int16>.V2):\t{0}", Avx2.AddSaturate(Vector256s<Int16>.Demo, Vector256s<Int16>.V2));
            ...
            foreach (byte cnt in new byte[] { 0, 1, 2 }) {
                WriteLine(tw, indent, "AlignRight - cnt={0} (0x{0:X}):", cnt);
                WriteLine(tw, indentNext, "AlignRight(Vector256s<Byte>.Demo, Vector256s<Byte>.V2, cnt):\t{0}", Avx2.AlignRight(Vector256s<Byte>.Demo, Vector256s<Byte>.V2, cnt));
                WriteLine(tw, indentNext, "AlignRight(Vector256s<Int16>.Demo, Vector256s<Int16>.V2, cnt):\t{0}", Avx2.AlignRight(Vector256s<Int16>.Demo, Vector256s<Int16>.V2, cnt));
                WriteLine(tw, indentNext, "AlignRight(Vector256s<Int32>.Demo, Vector256s<Int32>.V2, cnt):\t{0}", Avx2.AlignRight(Vector256s<Int32>.Demo, Vector256s<Int32>.V2, cnt));
            }
            ...
            // VPAND ymm, ymm, ymm/m256
            WriteLine(tw, indent, "And(Vector256s<Byte>.Demo, Vector256s<Byte>.V2):\t{0}", Avx2.And(Vector256s<Byte>.Demo, Vector256s<Byte>.V2));
            WriteLine(tw, indent, "And(Vector256s<UInt16>.Demo, Vector256s<UInt16>.V2):\t{0}", Avx2.And(Vector256s<UInt16>.Demo, Vector256s<UInt16>.V2));
            WriteLine(tw, indent, "And(Vector256s<UInt32>.Demo, Vector256s<UInt32>.V2):\t{0}", Avx2.And(Vector256s<UInt32>.Demo, Vector256s<UInt32>.V2));
            WriteLine(tw, indent, "And(Vector256s<UInt64>.Demo, Vector256s<UInt64>.V2):\t{0}", Avx2.And(Vector256s<UInt64>.Demo, Vector256s<UInt64>.V2));
            WriteLine(tw, indent, "And(Vector256s<SByte>.Demo, Vector256s<SByte>.V2):\t{0}", Avx2.And(Vector256s<SByte>.Demo, Vector256s<SByte>.V2));
            WriteLine(tw, indent, "And(Vector256s<Int16>.Demo, Vector256s<Int16>.V2):\t{0}", Avx2.And(Vector256s<Int16>.Demo, Vector256s<Int16>.V2));
            WriteLine(tw, indent, "And(Vector256s<Int32>.Demo, Vector256s<Int32>.V2):\t{0}", Avx2.And(Vector256s<Int32>.Demo, Vector256s<Int32>.V2));
            WriteLine(tw, indent, "And(Vector256s<Int64>.Demo, Vector256s<Int64>.V2):\t{0}", Avx2.And(Vector256s<Int64>.Demo, Vector256s<Int64>.V2));
            ...
            // VPANDN ymm, ymm, ymm/m256
            WriteLine(tw, indent, "AndNot(Vector256s<Byte>.Demo, Vector256s<Byte>.V2):\t{0}", Avx2.AndNot(Vector256s<Byte>.Demo, Vector256s<Byte>.V2));
            WriteLine(tw, indent, "AndNot(Vector256s<UInt16>.Demo, Vector256s<UInt16>.V2):\t{0}", Avx2.AndNot(Vector256s<UInt16>.Demo, Vector256s<UInt16>.V2));
            WriteLine(tw, indent, "AndNot(Vector256s<UInt32>.Demo, Vector256s<UInt32>.V2):\t{0}", Avx2.AndNot(Vector256s<UInt32>.Demo, Vector256s<UInt32>.V2));
            WriteLine(tw, indent, "AndNot(Vector256s<UInt64>.Demo, Vector256s<UInt64>.V2):\t{0}", Avx2.AndNot(Vector256s<UInt64>.Demo, Vector256s<UInt64>.V2));
            WriteLine(tw, indent, "AndNot(Vector256s<SByte>.Demo, Vector256s<SByte>.V2):\t{0}", Avx2.AndNot(Vector256s<SByte>.Demo, Vector256s<SByte>.V2));
            WriteLine(tw, indent, "AndNot(Vector256s<Int16>.Demo, Vector256s<Int16>.V2):\t{0}", Avx2.AndNot(Vector256s<Int16>.Demo, Vector256s<Int16>.V2));
            WriteLine(tw, indent, "AndNot(Vector256s<Int32>.Demo, Vector256s<Int32>.V2):\t{0}", Avx2.AndNot(Vector256s<Int32>.Demo, Vector256s<Int32>.V2));
            WriteLine(tw, indent, "AndNot(Vector256s<Int64>.Demo, Vector256s<Int64>.V2):\t{0}", Avx2.AndNot(Vector256s<Int64>.Demo, Vector256s<Int64>.V2));
            ...
            WriteLine(tw, indent, "Average(Vector256s<Byte>.Demo, Vector256s<Byte>.V2):\t{0}", Avx2.Average(Vector256s<Byte>.Demo, Vector256s<Byte>.V2));
            WriteLine(tw, indent, "Average(Vector256s<UInt16>.Demo, Vector256s<UInt16>.V2):\t{0}", Avx2.Average(Vector256s<UInt16>.Demo, Vector256s<UInt16>.V2));
            ...
            foreach (byte control in new byte[] { 1, 3, 0xCB }) {
                WriteLine(tw, indent, "Blend - control={0} (0x{0:X}):", control);
                WriteLine(tw, indentNext, "Blend(Vector128s<Int32>.Demo, Vector128s<Int32>.V2, control):\t{0}", Avx2.Blend(Vector128s<Int32>.Demo, Vector128s<Int32>.V2, control));
                WriteLine(tw, indentNext, "Blend(Vector256s<UInt16>.Demo, Vector256s<UInt16>.V2, control):\t{0}", Avx2.Blend(Vector256s<UInt16>.Demo, Vector256s<UInt16>.V2, control));
                WriteLine(tw, indentNext, "Blend(Vector256s<Int32>.Demo, Vector256s<Int32>.V2, control):\t{0}", Avx2.Blend(Vector256s<Int32>.Demo, Vector256s<Int32>.V2, control));
            }
            ...
            // 	FI
            // ENDFOR
            WriteLine(tw, indent, "BlendVariable(Vector256s<Byte>.Demo, Vector256s<Byte>.V2, Vector256s<Byte>.Demo):\t{0}", Avx2.BlendVariable(Vector256s<Byte>.Demo, Vector256s<Byte>.V2, Vector256s<Byte>.Demo));
            WriteLine(tw, indent, "BlendVariable(Vector256s<UInt16>.Demo, Vector256s<UInt16>.V2, Vector256s<UInt16>.Demo):\t{0}", Avx2.BlendVariable(Vector256s<UInt16>.Demo, Vector256s<UInt16>.V2, Vector256s<UInt16>.Demo));
            WriteLine(tw, indent, "BlendVariable(Vector256s<UInt32>.Demo, Vector256s<UInt32>.V2, Vector256s<UInt32>.Demo):\t{0}", Avx2.BlendVariable(Vector256s<UInt32>.Demo, Vector256s<UInt32>.V2, Vector256s<UInt32>.Demo));
            WriteLine(tw, indent, "BlendVariable(Vector256s<UInt64>.Demo, Vector256s<UInt64>.V2, Vector256s<UInt64>.Demo):\t{0}", Avx2.BlendVariable(Vector256s<UInt64>.Demo, Vector256s<UInt64>.V2, Vector256s<UInt64>.Demo));
            WriteLine(tw, indent, "BlendVariable(Vector256s<SByte>.Demo, Vector256s<SByte>.V2, Vector256s<SByte>.Demo):\t{0}", Avx2.BlendVariable(Vector256s<SByte>.Demo, Vector256s<SByte>.V2, Vector256s<SByte>.Demo));
            WriteLine(tw, indent, "BlendVariable(Vector256s<Int16>.Demo, Vector256s<Int16>.V2, Vector256s<Int16>.Demo):\t{0}", Avx2.BlendVariable(Vector256s<Int16>.Demo, Vector256s<Int16>.V2, Vector256s<Int16>.Demo));
            WriteLine(tw, indent, "BlendVariable(Vector256s<Int32>.Demo, Vector256s<Int32>.V2, Vector256s<Int32>.Demo):\t{0}", Avx2.BlendVariable(Vector256s<Int32>.Demo, Vector256s<Int32>.V2, Vector256s<Int32>.Demo));
            WriteLine(tw, indent, "BlendVariable(Vector256s<Int64>.Demo, Vector256s<Int64>.V2, Vector256s<Int64>.Demo):\t{0}", Avx2.BlendVariable(Vector256s<Int64>.Demo, Vector256s<Int64>.V2, Vector256s<Int64>.Demo));
            ...
            fixed (void* p = &Vector128s<Byte>.Demo) {
                WriteLine(tw, indent, "BroadcastScalarToVector128(&Vector128s<Byte>.Demo):\t{0}", Avx2.BroadcastScalarToVector128((byte*)p));
            }
            WriteLine(tw, indent, "BroadcastScalarToVector128(Vector128s<Byte>.Demo):\t{0}", Avx2.BroadcastScalarToVector128(Vector128s<Byte>.Demo));
            WriteLine(tw, indent, "BroadcastScalarToVector128(Vector128s<UInt16>.Demo):\t{0}", Avx2.BroadcastScalarToVector128(Vector128s<UInt16>.Demo));
            WriteLine(tw, indent, "BroadcastScalarToVector128(Vector128s<UInt32>.Demo):\t{0}", Avx2.BroadcastScalarToVector128(Vector128s<UInt32>.Demo));
            WriteLine(tw, indent, "BroadcastScalarToVector128(Vector128s<UInt64>.Demo):\t{0}", Avx2.BroadcastScalarToVector128(Vector128s<UInt64>.Demo));
            WriteLine(tw, indent, "BroadcastScalarToVector128(Vector128s<SByte>.Demo):\t{0}", Avx2.BroadcastScalarToVector128(Vector128s<SByte>.Demo));
            WriteLine(tw, indent, "BroadcastScalarToVector128(Vector128s<Int16>.Demo):\t{0}", Avx2.BroadcastScalarToVector128(Vector128s<Int16>.Demo));
            WriteLine(tw, indent, "BroadcastScalarToVector128(Vector128s<Int32>.Demo):\t{0}", Avx2.BroadcastScalarToVector128(Vector128s<Int32>.Demo));
            WriteLine(tw, indent, "BroadcastScalarToVector128(Vector128s<Int64>.Demo):\t{0}", Avx2.BroadcastScalarToVector128(Vector128s<Int64>.Demo));
            ...
            // VPBROADCASTQ ymm, xmm
            fixed (void* p = &Vector128s<Byte>.Demo) {
                WriteLine(tw, indent, "BroadcastScalarToVector256(&Vector128s<Byte>.Demo):\t{0}", Avx2.BroadcastScalarToVector256((byte*)p));
            }
            WriteLine(tw, indent, "BroadcastScalarToVector256(Vector128s<Byte>.Demo):\t{0}", Avx2.BroadcastScalarToVector256(Vector128s<Byte>.Demo));
            WriteLine(tw, indent, "BroadcastScalarToVector256(Vector128s<UInt16>.Demo):\t{0}", Avx2.BroadcastScalarToVector256(Vector128s<UInt16>.Demo));
            WriteLine(tw, indent, "BroadcastScalarToVector256(Vector128s<UInt32>.Demo):\t{0}", Avx2.BroadcastScalarToVector256(Vector128s<UInt32>.Demo));
            WriteLine(tw, indent, "BroadcastScalarToVector256(Vector128s<UInt64>.Demo):\t{0}", Avx2.BroadcastScalarToVector256(Vector128s<UInt64>.Demo));
            WriteLine(tw, indent, "BroadcastScalarToVector256(Vector128s<SByte>.Demo):\t{0}", Avx2.BroadcastScalarToVector256(Vector128s<SByte>.Demo));
            WriteLine(tw, indent, "BroadcastScalarToVector256(Vector128s<Int16>.Demo):\t{0}", Avx2.BroadcastScalarToVector256(Vector128s<Int16>.Demo));
            WriteLine(tw, indent, "BroadcastScalarToVector256(Vector128s<Int32>.Demo):\t{0}", Avx2.BroadcastScalarToVector256(Vector128s<Int32>.Demo));
            WriteLine(tw, indent, "BroadcastScalarToVector256(Vector128s<Int64>.Demo):\t{0}", Avx2.BroadcastScalarToVector256(Vector128s<Int64>.Demo));
            ...
            // dst[255:128] := a[127:0]
            fixed (void* p = &Vector128s<Byte>.Demo) {
                WriteLine(tw, indent, "BroadcastVector128ToVector256(&Vector128s<Byte>.Demo):\t{0}", Avx2.BroadcastVector128ToVector256((byte*)p));
            }
            fixed (void* p = &Vector128s<Int64>.Demo) {
                WriteLine(tw, indent, "BroadcastVector128ToVector256(&Vector128s<Int64>.Demo):\t{0}", Avx2.BroadcastVector128ToVector256((long*)p));
            }
            ...
            // VPCMPEQQ ymm, ymm, ymm/m256
            WriteLine(tw, indent, "CompareEqual(Vector256s<Byte>.Demo, Vector256s<Byte>.V2):\t{0}", Avx2.CompareEqual(Vector256s<Byte>.Demo, Vector256s<Byte>.V2));
            WriteLine(tw, indent, "CompareEqual(Vector256s<UInt16>.Demo, Vector256s<UInt16>.V2):\t{0}", Avx2.CompareEqual(Vector256s<UInt16>.Demo, Vector256s<UInt16>.V2));
            WriteLine(tw, indent, "CompareEqual(Vector256s<UInt32>.Demo, Vector256s<UInt32>.V2):\t{0}", Avx2.CompareEqual(Vector256s<UInt32>.Demo, Vector256s<UInt32>.V2));
            WriteLine(tw, indent, "CompareEqual(Vector256s<UInt64>.Demo, Vector256s<UInt64>.V2):\t{0}", Avx2.CompareEqual(Vector256s<UInt64>.Demo, Vector256s<UInt64>.V2));
            WriteLine(tw, indent, "CompareEqual(Vector256s<SByte>.Demo, Vector256s<SByte>.V2):\t{0}", Avx2.CompareEqual(Vector256s<SByte>.Demo, Vector256s<SByte>.V2));
            WriteLine(tw, indent, "CompareEqual(Vector256s<Int16>.Demo, Vector256s<Int16>.V2):\t{0}", Avx2.CompareEqual(Vector256s<Int16>.Demo, Vector256s<Int16>.V2));
            WriteLine(tw, indent, "CompareEqual(Vector256s<Int32>.Demo, Vector256s<Int32>.V2):\t{0}", Avx2.CompareEqual(Vector256s<Int32>.Demo, Vector256s<Int32>.V2));
            WriteLine(tw, indent, "CompareEqual(Vector256s<Int64>.Demo, Vector256s<Int64>.V2):\t{0}", Avx2.CompareEqual(Vector256s<Int64>.Demo, Vector256s<Int64>.V2));
            ...
            //WriteLine(tw, indent, "CompareGreaterThan(Vector256s<Byte>.Demo, Vector256s<Byte>.V2):\t{0}", Avx2.CompareGreaterThan(Vector256s<Byte>.Demo, Vector256s<Byte>.V2));
            //WriteLine(tw, indent, "CompareGreaterThan(Vector256s<UInt16>.Demo, Vector256s<UInt16>.V2):\t{0}", Avx2.CompareGreaterThan(Vector256s<UInt16>.Demo, Vector256s<UInt16>.V2));
            //WriteLine(tw, indent, "CompareGreaterThan(Vector256s<UInt32>.Demo, Vector256s<UInt32>.V2):\t{0}", Avx2.CompareGreaterThan(Vector256s<UInt32>.Demo, Vector256s<UInt32>.V2));
            //WriteLine(tw, indent, "CompareGreaterThan(Vector256s<UInt64>.Demo, Vector256s<UInt64>.V2):\t{0}", Avx2.CompareGreaterThan(Vector256s<UInt64>.Demo, Vector256s<UInt64>.V2));
            WriteLine(tw, indent, "CompareGreaterThan(Vector256s<SByte>.Demo, Vector256s<SByte>.V2):\t{0}", Avx2.CompareGreaterThan(Vector256s<SByte>.Demo, Vector256s<SByte>.V2));
            WriteLine(tw, indent, "CompareGreaterThan(Vector256s<Int16>.Demo, Vector256s<Int16>.V2):\t{0}", Avx2.CompareGreaterThan(Vector256s<Int16>.Demo, Vector256s<Int16>.V2));
            WriteLine(tw, indent, "CompareGreaterThan(Vector256s<Int32>.Demo, Vector256s<Int32>.V2):\t{0}", Avx2.CompareGreaterThan(Vector256s<Int32>.Demo, Vector256s<Int32>.V2));
            WriteLine(tw, indent, "CompareGreaterThan(Vector256s<Int64>.Demo, Vector256s<Int64>.V2):\t{0}", Avx2.CompareGreaterThan(Vector256s<Int64>.Demo, Vector256s<Int64>.V2));
            ...
            // dst[31:0] := a[31:0]
            WriteLine(tw, indent, "ConvertToInt32(Vector256s<Int32>.Demo):\t{0}", Avx2.ConvertToInt32(Vector256s<Int32>.Demo));
            WriteLine(tw, indent, "ConvertToUInt32(Vector256s<UInt32>.Demo):\t{0}", Avx2.ConvertToUInt32(Vector256s<UInt32>.Demo));
            ...
            // ENDFOR
            WriteLine(tw, indent, "ConvertToVector256Int16(Vector128s<Byte>.Demo):\t{0}", Avx2.ConvertToVector256Int16(Vector128s<Byte>.Demo));
            WriteLine(tw, indent, "ConvertToVector256Int16(Vector128s<SByte>.Demo):\t{0}", Avx2.ConvertToVector256Int16(Vector128s<SByte>.Demo));
            ...
            // VPMOVZXWD ymm, xmm
            WriteLine(tw, indent, "ConvertToVector256Int32(Vector128s<Byte>.Demo):\t{0}", Avx2.ConvertToVector256Int32(Vector128s<Byte>.Demo));
            WriteLine(tw, indent, "ConvertToVector256Int32(Vector128s<UInt16>.Demo):\t{0}", Avx2.ConvertToVector256Int32(Vector128s<UInt16>.Demo));
            WriteLine(tw, indent, "ConvertToVector256Int32(Vector128s<SByte>.Demo):\t{0}", Avx2.ConvertToVector256Int32(Vector128s<SByte>.Demo));
            WriteLine(tw, indent, "ConvertToVector256Int32(Vector128s<Int16>.Demo):\t{0}", Avx2.ConvertToVector256Int32(Vector128s<Int16>.Demo));
            ...
            // VPMOVZXDQ ymm, xmm
            WriteLine(tw, indent, "ConvertToVector256Int64(Vector128s<Byte>.Demo):\t{0}", Avx2.ConvertToVector256Int64(Vector128s<Byte>.Demo));
            WriteLine(tw, indent, "ConvertToVector256Int64(Vector128s<UInt16>.Demo):\t{0}", Avx2.ConvertToVector256Int64(Vector128s<UInt16>.Demo));
            WriteLine(tw, indent, "ConvertToVector256Int64(Vector128s<UInt32>.Demo):\t{0}", Avx2.ConvertToVector256Int64(Vector128s<UInt32>.Demo));
            WriteLine(tw, indent, "ConvertToVector256Int64(Vector128s<SByte>.Demo):\t{0}", Avx2.ConvertToVector256Int64(Vector128s<SByte>.Demo));
            WriteLine(tw, indent, "ConvertToVector256Int64(Vector128s<Int16>.Demo):\t{0}", Avx2.ConvertToVector256Int64(Vector128s<Int16>.Demo));
            WriteLine(tw, indent, "ConvertToVector256Int64(Vector128s<Int32>.Demo):\t{0}", Avx2.ConvertToVector256Int64(Vector128s<Int32>.Demo));
            ...
            foreach (byte idx in new byte[] { 0, 1 }) {
                WriteLine(tw, indent, "ExtractVector128 - idx={0} (0x{0:X}):", idx);
                WriteLine(tw, indentNext, "ExtractVector128(Vector256s<Byte>.Demo, idx):\t{0}", Avx2.ExtractVector128(Vector256s<Byte>.Demo, idx));
                WriteLine(tw, indentNext, "ExtractVector128(Vector256s<Int32>.Demo, idx):\t{0}", Avx2.ExtractVector128(Vector256s<Int32>.Demo, idx));
            }
            ...
            fixed (double* p = &srcArray_double[0]) {
                WriteLine(tw, indent, "GatherMaskVector128(Vector128s<Double>.V2, p, Vector128s<Int32>.Serial, Vector128s<Double>.Demo, sizeof(double)):\t{0}", Avx2.GatherMaskVector128(Vector128s<Double>.V2, p, Vector128s<Int32>.Serial, Vector128s<Double>.Demo, sizeof(double)));
                WriteLine(tw, indent, "GatherMaskVector128(Vector128s<Double>.V2, p, Vector128s<Int64>.Serial, Vector128s<Double>.Demo, sizeof(double)):\t{0}", Avx2.GatherMaskVector128(Vector128s<Double>.V2, p, Vector128s<Int64>.Serial, Vector128s<Double>.Demo, sizeof(double)));
            }
            ...
            fixed (int* p = &srcArray_int[0]) {
                WriteLine(tw, indent, "GatherMaskVector128(Vector128s<Int32>.V2, p, Vector128s<Int32>.Serial, Vector128s<Int32>.Demo, sizeof(int)):\t{0}", Avx2.GatherMaskVector128(Vector128s<Int32>.V2, p, Vector128s<Int32>.Serial, Vector128s<Int32>.Demo, sizeof(int)));
                WriteLine(tw, indent, "GatherMaskVector128(Vector128s<Int32>.V2, p, Vector128s<Int64>.Serial, Vector128s<Int32>.Demo, sizeof(int)):\t{0}", Avx2.GatherMaskVector128(Vector128s<Int32>.V2, p, Vector128s<Int64>.Serial, Vector128s<Int32>.Demo, sizeof(int)));
                WriteLine(tw, indent, "GatherMaskVector128(Vector128s<Int32>.V2, p, Vector256s<Int64>.Serial, Vector128s<Int32>.Demo, sizeof(int)):\t{0}", Avx2.GatherMaskVector128(Vector128s<Int32>.V2, p, Vector256s<Int64>.Serial, Vector128s<Int32>.Demo, sizeof(int)));
            }
            ...
            fixed (float* p = &srcArray_float[0]) {
                WriteLine(tw, indent, "GatherMaskVector128(Vector128s<Single>.V2, p, Vector128s<Int32>.Serial, Vector128s<Single>.Demo, sizeof(float)):\t{0}", Avx2.GatherMaskVector128(Vector128s<Single>.V2, p, Vector128s<Int32>.Serial, Vector128s<Single>.Demo, sizeof(float)));
                WriteLine(tw, indent, "GatherMaskVector128(Vector128s<Single>.V2, p, Vector128s<Int64>.Serial, Vector128s<Single>.Demo, sizeof(float)):\t{0}", Avx2.GatherMaskVector128(Vector128s<Single>.V2, p, Vector128s<Int64>.Serial, Vector128s<Single>.Demo, sizeof(float)));
                WriteLine(tw, indent, "GatherMaskVector128(Vector128s<Single>.V2, p, Vector256s<Int64>.Serial, Vector128s<Single>.Demo, sizeof(float)):\t{0}", Avx2.GatherMaskVector128(Vector128s<Single>.V2, p, Vector256s<Int64>.Serial, Vector128s<Single>.Demo, sizeof(float)));
            }
            ...
            // VPGATHERQQ ymm, vm32y, ymm
            fixed (double* p = &srcArray_double[0]) {
                WriteLine(tw, indent, "GatherMaskVector256(Vector256s<Double>.V2, p, Vector128s<Int32>.Serial, Vector256s<Double>.Demo, sizeof(double)):\t{0}", Avx2.GatherMaskVector256(Vector256s<Double>.V2, p, Vector128s<Int32>.Serial, Vector256s<Double>.Demo, sizeof(double)));
                WriteLine(tw, indent, "GatherMaskVector256(Vector256s<Double>.V2, p, Vector256s<Int64>.Serial, Vector256s<Double>.Demo, sizeof(double)):\t{0}", Avx2.GatherMaskVector256(Vector256s<Double>.V2, p, Vector256s<Int64>.Serial, Vector256s<Double>.Demo, sizeof(double)));
            }
            fixed (int* p = &srcArray_int[0]) {
                WriteLine(tw, indent, "GatherMaskVector256(Vector256s<Int32>.V2, p, Vector256s<Int64>.Serial, Vector256s<Int32>.Demo, sizeof(int)):\t{0}", Avx2.GatherMaskVector256(Vector256s<Int32>.V2, p, Vector256s<Int32>.Serial, Vector256s<Int32>.Demo, sizeof(int)));
            }
            fixed (float* p = &srcArray_float[0]) {
                WriteLine(tw, indent, "GatherMaskVector256(Vector256s<Single>.V2, p, Vector256s<Int64>.Serial, Vector256s<Single>.Demo, sizeof(float)):\t{0}", Avx2.GatherMaskVector256(Vector256s<Single>.V2, p, Vector256s<Int32>.Serial, Vector256s<Single>.Demo, sizeof(float)));
            }
            ...
            // VPGATHERQQ xmm, vm64x, xmm
            fixed (double* p = &srcArray_double[0]) {
                WriteLine(tw, indent, "GatherVector128(p, Vector128s<Int32>.Serial, sizeof(double)):\t{0}", Avx2.GatherVector128(p, Vector128s<Int32>.Serial, sizeof(double)));
                WriteLine(tw, indent, "GatherVector128(p, Vector128s<Int64>.Serial, sizeof(double)):\t{0}", Avx2.GatherVector128(p, Vector128s<Int64>.Serial, sizeof(double)));
            }
            fixed (float* p = &srcArray_float[0]) {
                WriteLine(tw, indent, "GatherVector128(p, Vector128s<Int32>.Serial, sizeof(float)):\t{0}", Avx2.GatherVector128(p, Vector128s<Int32>.Serial, sizeof(float)));
                WriteLine(tw, indent, "GatherVector128(p, Vector256s<Int64>.Serial, sizeof(float)):\t{0}", Avx2.GatherVector128(p, Vector256s<Int64>.Serial, sizeof(float)));
            }
            fixed (int* p = &srcArray_int[0]) {
                WriteLine(tw, indent, "GatherVector128(p, Vector128s<Int32>.Serial, sizeof(int)):\t{0}", Avx2.GatherVector128(p, Vector128s<Int32>.Serial, sizeof(int)));
                WriteLine(tw, indent, "GatherVector128(p, Vector256s<Int64>.Serial, sizeof(int)):\t{0}", Avx2.GatherVector128(p, Vector256s<Int64>.Serial, sizeof(int)));
                try {
                    WriteLine(tw, indent, "GatherVector128(p, Vector128.Create((int)0, 1, 0, 3), sizeof(int)):\t{0}", Avx2.GatherVector128(p, Vector128.Create((int)0, 1, 0, 3), sizeof(int)));
                    WriteLine(tw, indent, "GatherVector128(p, Vector128.Create((int)0, 1, 0, -1), sizeof(int)):\t{0}", Avx2.GatherVector128(p, Vector128.Create((int)0, 1, 0, -1), sizeof(int)));
                } catch (Exception ex) {
                    WriteLine(tw, indent, "GatherVector128 fail by srcArray_int! {0}", ex.Message);
                }
            }
            fixed (byte* p0 = &srcArray_byte[0]) {
                int* p = (int*)p0;
                try {
                    WriteLine(tw, indent, "GatherVector128(p, Vector128s<Int32>.Serial, 1):\t{0}", Avx2.GatherVector128(p, Vector128s<Int32>.Serial, 1));
                    WriteLine(tw, indent, "GatherVector128(p, Vector256s<Int64>.Serial, 1):\t{0}", Avx2.GatherVector128(p, Vector256s<Int64>.Serial, 1));
                    WriteLine(tw, indent, "GatherVector128(p, Vector128.Create((int)0, 1, 0, 3), 1):\t{0}", Avx2.GatherVector128(p, Vector128.Create((int)0, 1, 0, 3), 1));
                    WriteLine(tw, indent, "GatherVector128(p, Vector128.Create((int)0, 1, 0, -1), 1):\t{0}", Avx2.GatherVector128(p, Vector128.Create((int)0, 1, 0, -1), 1));
                    Vector128<int> vByteMask = Vector128.Create((int)0xFF);
                    WriteLine(tw, indent, "GatherVector128 - vByteMask:\t{0}", vByteMask);
                    WriteLine(tw, indent, "Avx2.And(vByteMask, GatherVector128(p, Vector128s<Int32>.Serial, 1)):\t{0}", Avx2.And(vByteMask, Avx2.GatherVector128(p, Vector128s<Int32>.Serial, 1)));
                    WriteLine(tw, indent, "Avx2.And(vByteMask, GatherVector128(p, Vector256s<Int64>.Serial, 1)):\t{0}", Avx2.And(vByteMask, Avx2.GatherVector128(p, Vector256s<Int64>.Serial, 1)));
                    WriteLine(tw, indent, "Avx2.And(vByteMask, GatherVector128(p, Vector128.Create((int)0, 1, 0, 3), 1)):\t{0}", Avx2.And(vByteMask, Avx2.GatherVector128(p, Vector128.Create((int)0, 1, 0, 3), 1)));
                    WriteLine(tw, indent, "Avx2.And(vByteMask, GatherVector128(p, Vector128.Create((int)0, 1, 0, -1), 1)):\t{0}", Avx2.And(vByteMask, Avx2.GatherVector128(p, Vector128.Create((int)0, 1, 0, -1), 1)));
                } catch (Exception ex) {
                    WriteLine(tw, indent, "GatherVector128 fail by srcArray_byte! {0}", ex.Message);
                }
            }
            ...
            // VPGATHERQQ ymm, vm64y, ymm
            fixed (double* p = &srcArray_double[0]) {
                WriteLine(tw, indent, "GatherVector256(p, Vector128s<Int32>.Serial, sizeof(double)):\t{0}", Avx2.GatherVector256(p, Vector128s<Int32>.Serial, sizeof(double)));
                WriteLine(tw, indent, "GatherVector256(p, Vector256s<Int64>.Serial, sizeof(double)):\t{0}", Avx2.GatherVector256(p, Vector256s<Int64>.Serial, sizeof(double)));
            }
            fixed (int* p = &srcArray_int[0]) {
                WriteLine(tw, indent, "GatherVector256(p, Vector256s<Int32>.Serial, sizeof(int)):\t{0}", Avx2.GatherVector256(p, Vector256s<Int32>.Serial, sizeof(int)));
            }
            fixed (float* p = &srcArray_float[0]) {
                WriteLine(tw, indent, "GatherVector256(p, Vector256s<Int32>.Serial, sizeof(float)):\t{0}", Avx2.GatherVector256(p, Vector256s<Int32>.Serial, sizeof(float)));
            }
            ...
            WriteLine(tw, indent, "HorizontalAdd(Vector256s<Int16>.Demo, Vector256s<Int16>.V2):\t{0}", Avx2.HorizontalAdd(Vector256s<Int16>.Demo, Vector256s<Int16>.V2));
            WriteLine(tw, indent, "HorizontalAdd(Vector256s<Int32>.Demo, Vector256s<Int32>.V2):\t{0}", Avx2.HorizontalAdd(Vector256s<Int32>.Demo, Vector256s<Int32>.V2));
            ...
            WriteLine(tw, indent, "HorizontalAddSaturate(Vector256s<Int16>.Demo, Vector256s<Int16>.V2):\t{0}", Avx2.HorizontalAddSaturate(Vector256s<Int16>.Demo, Vector256s<Int16>.V2));
            ...
            WriteLine(tw, indent, "HorizontalSubtract(Vector256s<Int16>.Demo, Vector256s<Int16>.V2):\t{0}", Avx2.HorizontalSubtract(Vector256s<Int16>.Demo, Vector256s<Int16>.V2));
            WriteLine(tw, indent, "HorizontalSubtract(Vector256s<Int32>.Demo, Vector256s<Int32>.V2):\t{0}", Avx2.HorizontalSubtract(Vector256s<Int32>.Demo, Vector256s<Int32>.V2));
            ...
            WriteLine(tw, indent, "HorizontalSubtractSaturate(Vector256s<Int16>.Demo, Vector256s<Int16>.V2):\t{0}", Avx2.HorizontalSubtractSaturate(Vector256s<Int16>.Demo, Vector256s<Int16>.V2));
            ...
            foreach (byte idx in new byte[] { 0, 1 }) {
                WriteLine(tw, indent, "InsertVector128 - idx={0} (0x{0:X}):", idx);
                WriteLine(tw, indentNext, "InsertVector128(Vector256s<Byte>.Demo, Vector128s<Byte>.V2, idx):\t{0}", Avx2.InsertVector128(Vector256s<Byte>.Demo, Vector128s<Byte>.V2, idx));
                WriteLine(tw, indentNext, "InsertVector128(Vector256s<Int32>.Demo, Vector128s<Int32>.V2, idx):\t{0}", Avx2.InsertVector128(Vector256s<Int32>.Demo, Vector128s<Int32>.V2, idx));
            }
            ...
            // ENDFOR
            fixed (int* p = &srcArray_int[0]) {
                WriteLine(tw, indent, "MaskLoad(p, Vector128s<Int32>.Demo):\t{0}", Avx2.MaskLoad(p, Vector128s<Int32>.Demo));
                WriteLine(tw, indent, "MaskLoad(p, Vector256s<Int32>.Demo):\t{0}", Avx2.MaskLoad(p, Vector256s<Int32>.Demo));
            }
            fixed (long* p = &srcArray_long[0]) {
                WriteLine(tw, indent, "MaskLoad(p, Vector128s<Int64>.Demo):\t{0}", Avx2.MaskLoad(p, Vector128s<Int64>.Demo));
                WriteLine(tw, indent, "MaskLoad(p, Vector256s<Int64>.Demo):\t{0}", Avx2.MaskLoad(p, Vector256s<Int64>.Demo));
            }
            ...
            WriteLine(tw, indent, "MaskStore((int*)&srcS_128_int, Vector128s<Int32>.Demo, Vector128s<Int32>.V1):\t{0}", srcS_128_int);
            Vector256<int> srcS_256_int = Vector256s<Int32>.V2;
            Avx2.MaskStore((int*)&srcS_256_int, Vector256s<Int32>.Demo, Vector256s<Int32>.V1);
            WriteLine(tw, indent, "MaskStore((int*)&srcS_256_int, Vector256s<Int32>.Demo, Vector256s<Int32>.V1):\t{0}", srcS_256_int);
            ...
            WriteLine(tw, indent, "MaskStore((ulong*)&srcS_128_ulong, Vector128s<UInt64>.Demo, Vector128s<UInt64>.V1):\t{0}", srcS_128_ulong);
            ...
            WriteLine(tw, indent, "MaskStore((ulong*)&srcS_256_ulong, Vector256s<UInt64>.Demo, Vector256s<UInt64>.V1):\t{0}", srcS_256_ulong);
            ...
            WriteLine(tw, indent, "Max(Vector256s<Byte>.Demo, Vector256s<Byte>.V2):\t{0}", Avx2.Max(Vector256s<Byte>.Demo, Vector256s<Byte>.V2));
            WriteLine(tw, indent, "Max(Vector256s<UInt16>.Demo, Vector256s<UInt16>.V2):\t{0}", Avx2.Max(Vector256s<UInt16>.Demo, Vector256s<UInt16>.V2));
            WriteLine(tw, indent, "Max(Vector256s<UInt32>.Demo, Vector256s<UInt32>.V2):\t{0}", Avx2.Max(Vector256s<UInt32>.Demo, Vector256s<UInt32>.V2));
            //WriteLine(tw, indent, "Max(Vector256s<UInt64>.Demo, Vector256s<UInt64>.V2):\t{0}", Avx2.Max(Vector256s<UInt64>.Demo, Vector256s<UInt64>.V2));
            WriteLine(tw, indent, "Max(Vector256s<SByte>.Demo, Vector256s<SByte>.V2):\t{0}", Avx2.Max(Vector256s<SByte>.Demo, Vector256s<SByte>.V2));
            WriteLine(tw, indent, "Max(Vector256s<Int16>.Demo, Vector256s<Int16>.V2):\t{0}", Avx2.Max(Vector256s<Int16>.Demo, Vector256s<Int16>.V2));
            WriteLine(tw, indent, "Max(Vector256s<Int32>.Demo, Vector256s<Int32>.V2):\t{0}", Avx2.Max(Vector256s<Int32>.Demo, Vector256s<Int32>.V2));
            //WriteLine(tw, indent, "Max(Vector256s<Int64>.Demo, Vector256s<Int64>.V2):\t{0}", Avx2.Max(Vector256s<Int64>.Demo, Vector256s<Int64>.V2));
            ...
            WriteLine(tw, indent, "Min(Vector256s<Byte>.Demo, Vector256s<Byte>.V2):\t{0}", Avx2.Min(Vector256s<Byte>.Demo, Vector256s<Byte>.V2));
            WriteLine(tw, indent, "Min(Vector256s<UInt16>.Demo, Vector256s<UInt16>.V2):\t{0}", Avx2.Min(Vector256s<UInt16>.Demo, Vector256s<UInt16>.V2));
            WriteLine(tw, indent, "Min(Vector256s<UInt32>.Demo, Vector256s<UInt32>.V2):\t{0}", Avx2.Min(Vector256s<UInt32>.Demo, Vector256s<UInt32>.V2));
            //WriteLine(tw, indent, "Min(Vector256s<UInt64>.Demo, Vector256s<UInt64>.V2):\t{0}", Avx2.Min(Vector256s<UInt64>.Demo, Vector256s<UInt64>.V2));
            WriteLine(tw, indent, "Min(Vector256s<SByte>.Demo, Vector256s<SByte>.V2):\t{0}", Avx2.Min(Vector256s<SByte>.Demo, Vector256s<SByte>.V2));
            WriteLine(tw, indent, "Min(Vector256s<Int16>.Demo, Vector256s<Int16>.V2):\t{0}", Avx2.Min(Vector256s<Int16>.Demo, Vector256s<Int16>.V2));
            WriteLine(tw, indent, "Min(Vector256s<Int32>.Demo, Vector256s<Int32>.V2):\t{0}", Avx2.Min(Vector256s<Int32>.Demo, Vector256s<Int32>.V2));
            //WriteLine(tw, indent, "Min(Vector256s<Int64>.Demo, Vector256s<Int64>.V2):\t{0}", Avx2.Min(Vector256s<Int64>.Demo, Vector256s<Int64>.V2));
            ...
            // 	dst[j] := a[i+7]
            // ENDFOR
            WriteLine(tw, indent, "MoveMask(Vector256s<Byte>.Demo):\t{0}\t# 0x{0:X8}", Avx2.MoveMask(Vector256s<Byte>.Demo));
            WriteLine(tw, indent, "MoveMask(Vector256s<SByte>.Demo):\t{0}\t# 0x{0:X8}", Avx2.MoveMask(Vector256s<SByte>.Demo));
            ...
            for (byte i = 0; i < 8; ++i) {
                ...
                WriteLine(tw, indent, "MultipleSumAbsoluteDifferences(Vector256s<Byte>.Demo, Vector256s<Byte>.Serial, " + key + "):\t{0}", Avx2.MultipleSumAbsoluteDifferences(Vector256s<Byte>.Demo, Vector256s<Byte>.Serial, mask));
            }
            ...
            // ENDFOR
            WriteLine(tw, indent, "Multiply(Vector256s<Int32>.Demo, Vector256s<Int32>.V2):\t{0}", Avx2.Multiply(Vector256s<Int32>.Demo, Vector256s<Int32>.V2));
            WriteLine(tw, indent, "Multiply(Vector256s<UInt32>.Demo, Vector256s<UInt32>.V2):\t{0}", Avx2.Multiply(Vector256s<UInt32>.Demo, Vector256s<UInt32>.V2));
            ...
            // ENDFOR
            WriteLine(tw, indent, "MultiplyAddAdjacent(Vector256s<Byte>.Demo, Vector256s<SByte>.V2):\t{0}", Avx2.MultiplyAddAdjacent(Vector256s<Byte>.Demo, Vector256s<SByte>.V2));
            //WriteLine(tw, indent, "MultiplyAddAdjacent(Vector256s<Byte>.Demo, Vector256s<Byte>.V2.AsSByte()):\t{0}", Avx2.MultiplyAddAdjacent(Vector256s<Byte>.Demo, Vector256s<Byte>.V2.AsSByte()));
            WriteLine(tw, indent, "MultiplyAddAdjacent(Vector256s<SByte>.V2, Vector256s<SByte>.Demo):\t{0}", Avx2.MultiplyAddAdjacent(Vector256s<Byte>.V2, Vector256s<SByte>.Demo));
            //WriteLine(tw, indent, "MultiplyAddAdjacent(Vector256s<SByte>.V2, Vector256s<Byte>.Demo.AsSByte()):\t{0}", Avx2.MultiplyAddAdjacent(Vector256s<Byte>.V2, Vector256s<Byte>.Demo.AsSByte()));
            WriteLine(tw, indent, "MultiplyAddAdjacent(Vector256s<Int16>.Demo, Vector256s<Int16>.V2):\t{0}", Avx2.MultiplyAddAdjacent(Vector256s<Int16>.Demo, Vector256s<Int16>.V2));
            ...
            // 	dst[i+15:i] := tmp[31:16]
            // ENDFOR
            WriteLine(tw, indent, "MultiplyHigh(Vector256s<UInt16>.Demo, Vector256s<UInt16>.V2):\t{0}", Avx2.MultiplyHigh(Vector256s<UInt16>.Demo, Vector256s<UInt16>.V2));
            WriteLine(tw, indent, "MultiplyHigh(Vector256s<Int16>.Demo, Vector256s<Int16>.V2):\t{0}", Avx2.MultiplyHigh(Vector256s<Int16>.Demo, Vector256s<Int16>.V2));
            ...
            // 	dst[i+15:i] := tmp[16:1]
            // ENDFOR
            WriteLine(tw, indent, "MultiplyHighRoundScale(Vector256s<Int16>.Demo, Vector256s<Int16>.V2):\t{0}", Avx2.MultiplyHighRoundScale(Vector256s<Int16>.Demo, Vector256s<Int16>.V2));
            ...
            // VPMULLD ymm, ymm, ymm/m256
            WriteLine(tw, indent, "MultiplyLow(Vector256s<UInt16>.Demo, Vector256s<UInt16>.V2):\t{0}", Avx2.MultiplyLow(Vector256s<UInt16>.Demo, Vector256s<UInt16>.V2));
            WriteLine(tw, indent, "MultiplyLow(Vector256s<Int16>.Demo, Vector256s<Int16>.V2):\t{0}", Avx2.MultiplyLow(Vector256s<Int16>.Demo, Vector256s<Int16>.V2));
            WriteLine(tw, indent, "MultiplyLow(Vector256s<UInt32>.Demo, Vector256s<UInt32>.V2):\t{0}", Avx2.MultiplyLow(Vector256s<UInt32>.Demo, Vector256s<UInt32>.V2));
            WriteLine(tw, indent, "MultiplyLow(Vector256s<Int32>.Demo, Vector256s<Int32>.V2):\t{0}", Avx2.MultiplyLow(Vector256s<Int32>.Demo, Vector256s<Int32>.V2));
            ...
            // VPOR ymm, ymm, ymm/m256
            WriteLine(tw, indent, "Or(Vector256s<Byte>.Demo, Vector256s<Byte>.V2):\t{0}", Avx2.Or(Vector256s<Byte>.Demo, Vector256s<Byte>.V2));
            WriteLine(tw, indent, "Or(Vector256s<UInt16>.Demo, Vector256s<UInt16>.V2):\t{0}", Avx2.Or(Vector256s<UInt16>.Demo, Vector256s<UInt16>.V2));
            WriteLine(tw, indent, "Or(Vector256s<UInt32>.Demo, Vector256s<UInt32>.V2):\t{0}", Avx2.Or(Vector256s<UInt32>.Demo, Vector256s<UInt32>.V2));
            WriteLine(tw, indent, "Or(Vector256s<UInt64>.Demo, Vector256s<UInt64>.V2):\t{0}", Avx2.Or(Vector256s<UInt64>.Demo, Vector256s<UInt64>.V2));
            WriteLine(tw, indent, "Or(Vector256s<SByte>.Demo, Vector256s<SByte>.V2):\t{0}", Avx2.Or(Vector256s<SByte>.Demo, Vector256s<SByte>.V2));
            WriteLine(tw, indent, "Or(Vector256s<Int16>.Demo, Vector256s<Int16>.V2):\t{0}", Avx2.Or(Vector256s<Int16>.Demo, Vector256s<Int16>.V2));
            WriteLine(tw, indent, "Or(Vector256s<Int32>.Demo, Vector256s<Int32>.V2):\t{0}", Avx2.Or(Vector256s<Int32>.Demo, Vector256s<Int32>.V2));
            WriteLine(tw, indent, "Or(Vector256s<Int64>.Demo, Vector256s<Int64>.V2):\t{0}", Avx2.Or(Vector256s<Int64>.Demo, Vector256s<Int64>.V2));
            ...
            WriteLine(tw, indent, "PackSignedSaturate(Vector256s<Int16>.Demo, Vector256s<Int16>.V2):\t{0}", Avx2.PackSignedSaturate(Vector256s<Int16>.Demo, Vector256s<Int16>.V2));
            WriteLine(tw, indent, "PackSignedSaturate(Vector256s<Int32>.Demo, Vector256s<Int32>.V2):\t{0}", Avx2.PackSignedSaturate(Vector256s<Int32>.Demo, Vector256s<Int32>.V2));
            ...
            WriteLine(tw, indent, "PackUnsignedSaturate(Vector256s<Int16>.Demo, Vector256s<Int16>.V2):\t{0}", Avx2.PackUnsignedSaturate(Vector256s<Int16>.Demo, Vector256s<Int16>.V2));
            WriteLine(tw, indent, "PackUnsignedSaturate(Vector256s<Int32>.Demo, Vector256s<Int32>.V2):\t{0}", Avx2.PackUnsignedSaturate(Vector256s<Int32>.Demo, Vector256s<Int32>.V2));
            ...
            foreach (byte control in new byte[] { 0, 1, 2, 3, 0x23, 0xA3, 0x10 }) {
                WriteLine(tw, indent, "Permute2x128 - control={0} (0x{0:X}):", control);
                WriteLine(tw, indentNext, "Permute2x128(Vector256s<Byte>.Demo, Vector256s<Byte>.V2, control):\t{0}", Avx2.Permute2x128(Vector256s<Byte>.Demo, Vector256s<Byte>.V2, control));
                WriteLine(tw, indentNext, "Permute2x128(Vector256s<Int32>.Demo, Vector256s<Int32>.V2, control):\t{0}", Avx2.Permute2x128(Vector256s<Int32>.Demo, Vector256s<Int32>.V2, control));
            }
            ...
            // dst[255:192] := SELECT4(a[255:0], imm8[7:6])
            foreach (byte control in new byte[] { 0, 1, 2, 3, 0x23, 0xA3, 0x10 }) {
                WriteLine(tw, indent, "Permute4x64 - control={0} (0x{0:X}):", control);
                WriteLine(tw, indentNext, "Permute4x64(Vector256s<Double>.Demo, control):\t{0}", Avx2.Permute4x64(Vector256s<Double>.Demo, control));
                WriteLine(tw, indentNext, "Permute4x64(Vector256s<Int64>.Demo, control):\t{0}", Avx2.Permute4x64(Vector256s<Int64>.Demo, control));
            }
            ...
            // VPERMD ymm, ymm/m256, ymm
            WriteLine(tw, indent, "PermuteVar8x32(Vector256s<Single>.Demo, Vector256s<Int32>.Serial):\t{0}", Avx2.PermuteVar8x32(Vector256s<Single>.Demo, Vector256s<Int32>.Serial));
            WriteLine(tw, indent, "PermuteVar8x32(Vector256s<Int32>.Demo, Vector256s<Int32>.Serial):\t{0}", Avx2.PermuteVar8x32(Vector256s<Int32>.Demo, Vector256s<Int32>.Serial));
            WriteLine(tw, indent, "PermuteVar8x32(Vector256s<UInt32>.Demo, Vector256s<UInt32>.Serial):\t{0}", Avx2.PermuteVar8x32(Vector256s<UInt32>.Demo, Vector256s<UInt32>.Serial));
            WriteLine(tw, indent, "PermuteVar8x32(Vector256s<Single>.Demo, Vector256s<Int32>.V1):\t{0}", Avx2.PermuteVar8x32(Vector256s<Single>.Demo, Vector256s<Int32>.V1));
            WriteLine(tw, indent, "PermuteVar8x32(Vector256s<Int32>.Demo, Vector256s<Int32>.V1):\t{0}", Avx2.PermuteVar8x32(Vector256s<Int32>.Demo, Vector256s<Int32>.V1));
            WriteLine(tw, indent, "PermuteVar8x32(Vector256s<UInt32>.Demo, Vector256s<UInt32>.V1):\t{0}", Avx2.PermuteVar8x32(Vector256s<UInt32>.Demo, Vector256s<UInt32>.V1));
            ...
            foreach (byte count in new byte[] { 1 }) {
                WriteLine(tw, indent, "ShiftLeftLogical - count={0} (0x{0:X}):", count);
                WriteLine(tw, indentNext, "ShiftLeftLogical(Vector256s<UInt16>.Demo, Vector128.CreateScalar((ushort)count)):\t{0}", Avx2.ShiftLeftLogical(Vector256s<UInt16>.Demo, Vector128.CreateScalar((ushort)count)));
                WriteLine(tw, indentNext, "ShiftLeftLogical(Vector256s<UInt16>.Demo, count):\t{0}", Avx2.ShiftLeftLogical(Vector256s<UInt16>.Demo, count));
                //Debugger.Break();
                WriteLine(tw, indentNext, "ShiftLeftLogical(Vector256s<UInt32>.Demo, count):\t{0}", Avx2.ShiftLeftLogical(Vector256s<UInt32>.Demo, count));
                WriteLine(tw, indentNext, "ShiftLeftLogical(Vector256s<UInt64>.Demo, count):\t{0}", Avx2.ShiftLeftLogical(Vector256s<UInt64>.Demo, count));
                WriteLine(tw, indentNext, "ShiftLeftLogical(Vector256s<Int16>.Demo, count):\t{0}", Avx2.ShiftLeftLogical(Vector256s<Int16>.Demo, count));
                WriteLine(tw, indentNext, "ShiftLeftLogical(Vector256s<Int32>.Demo, count):\t{0}", Avx2.ShiftLeftLogical(Vector256s<Int32>.Demo, count));
                WriteLine(tw, indentNext, "ShiftLeftLogical(Vector256s<Int64>.Demo, count):\t{0}", Avx2.ShiftLeftLogical(Vector256s<Int64>.Demo, count));
            }
            ...
            foreach (byte count in new byte[] { 1, 15 }) {
                WriteLine(tw, indent, "ShiftLeftLogical128BitLane - count={0} (0x{0:X}):", count);
                WriteLine(tw, indentNext, "ShiftLeftLogical128BitLane(Vector256s<Byte>.Demo, count):\t{0}", Avx2.ShiftLeftLogical128BitLane(Vector256s<Byte>.Demo, count));
                WriteLine(tw, indentNext, "ShiftLeftLogical128BitLane(Vector256s<UInt16>.Demo, count):\t{0}", Avx2.ShiftLeftLogical128BitLane(Vector256s<UInt16>.Demo, count));
                WriteLine(tw, indentNext, "ShiftLeftLogical128BitLane(Vector256s<UInt32>.Demo, count):\t{0}", Avx2.ShiftLeftLogical128BitLane(Vector256s<UInt32>.Demo, count));
                WriteLine(tw, indentNext, "ShiftLeftLogical128BitLane(Vector256s<UInt64>.Demo, count):\t{0}", Avx2.ShiftLeftLogical128BitLane(Vector256s<UInt64>.Demo, count));
                WriteLine(tw, indentNext, "ShiftLeftLogical128BitLane(Vector256s<SByte>.Demo, count):\t{0}", Avx2.ShiftLeftLogical128BitLane(Vector256s<SByte>.Demo, count));
                WriteLine(tw, indentNext, "ShiftLeftLogical128BitLane(Vector256s<Int16>.Demo, count):\t{0}", Avx2.ShiftLeftLogical128BitLane(Vector256s<Int16>.Demo, count));
                WriteLine(tw, indentNext, "ShiftLeftLogical128BitLane(Vector256s<Int32>.Demo, count):\t{0}", Avx2.ShiftLeftLogical128BitLane(Vector256s<Int32>.Demo, count));
                WriteLine(tw, indentNext, "ShiftLeftLogical128BitLane(Vector256s<Int64>.Demo, count):\t{0}", Avx2.ShiftLeftLogical128BitLane(Vector256s<Int64>.Demo, count));
            }
            ...
            // 	FI
            // ENDFOR
            WriteLine(tw, indent, "ShiftLeftLogicalVariable(Vector128s<Int32>.V2, Vector128s<UInt32>.Serial):\t{0}", Avx2.ShiftLeftLogicalVariable(Vector128s<Int32>.V2, Vector128s<UInt32>.Serial));
            WriteLine(tw, indent, "ShiftLeftLogicalVariable(Vector128s<Int64>.V2, Vector128s<UInt64>.Serial):\t{0}", Avx2.ShiftLeftLogicalVariable(Vector128s<Int64>.V2, Vector128s<UInt64>.Serial));
            ...
            // 	FI
            // ENDFOR
            WriteLine(tw, indent, "ShiftLeftLogicalVariable(Vector256s<Int32>.V2, Vector256s<UInt32>.Serial):\t{0}", Avx2.ShiftLeftLogicalVariable(Vector256s<Int32>.V2, Vector256s<UInt32>.Serial));
            WriteLine(tw, indent, "ShiftLeftLogicalVariable(Vector256s<Int64>.V2, Vector256s<UInt64>.Serial):\t{0}", Avx2.ShiftLeftLogicalVariable(Vector256s<Int64>.V2, Vector256s<UInt64>.Serial));
            ...
            foreach (byte count in new byte[] { 1 }) {
                WriteLine(tw, indent, "ShiftRightArithmetic - count={0} (0x{0:X}):", count);
                WriteLine(tw, indentNext, "ShiftRightArithmetic(Vector256s<UInt16>.Demo, Vector128.CreateScalar((ushort)count)):\t{0}", Avx2.ShiftRightArithmetic(Vector256s<Int16>.Demo, Vector128.CreateScalar((short)count)));
                WriteLine(tw, indentNext, "ShiftRightArithmetic(Vector256s<Int16>.Demo, count):\t{0}", Avx2.ShiftRightArithmetic(Vector256s<Int16>.Demo, count));
                WriteLine(tw, indentNext, "ShiftRightArithmetic(Vector256s<Int32>.Demo, count):\t{0}", Avx2.ShiftRightArithmetic(Vector256s<Int32>.Demo, count));
                //WriteLine(tw, indentNext, "ShiftRightArithmetic(Vector256s<Int64>.Demo, count):\t{0}", Avx2.ShiftRightArithmetic(Vector256s<Int64>.Demo, count));
            }
            ...
            WriteLine(tw, indent, "ShiftRightArithmeticVariable(Vector128s<Int32>.V2, Vector128s<UInt32>.Serial):\t{0}", Avx2.ShiftRightArithmeticVariable(Vector128s<Int32>.V2, Vector128s<UInt32>.Serial));
            WriteLine(tw, indent, "ShiftRightArithmeticVariable(Vector256s<Int32>.V2, Vector256s<UInt32>.Serial):\t{0}", Avx2.ShiftRightArithmeticVariable(Vector256s<Int32>.V2, Vector256s<UInt32>.Serial));
            //WriteLine(tw, indent, "ShiftRightArithmeticVariable(Vector256s<Int64>.V2, Vector256s<UInt64>.Serial):\t{0}", Avx2.ShiftRightArithmeticVariable(Vector256s<Int64>.V2, Vector256s<UInt64>.Serial));
            WriteLine(tw, indent, "ShiftRightArithmeticVariable(Vector256s<Int32>.Demo, Vector256s<UInt32>.Serial):\t{0}", Avx2.ShiftRightArithmeticVariable(Vector256s<Int32>.Demo, Vector256s<UInt32>.Serial));
            ...
            // VPSRLQ ymm, ymm, xmm/m128
            foreach (byte count in new byte[] { 1 }) {
                WriteLine(tw, indent, "ShiftRightLogical - count={0} (0x{0:X}):", count);
                WriteLine(tw, indentNext, "ShiftRightLogical(Vector256s<UInt16>.Demo, Vector128.CreateScalar((ushort)count)):\t{0}", Avx2.ShiftRightLogical(Vector256s<UInt16>.Demo, Vector128.CreateScalar((ushort)count)));
                WriteLine(tw, indentNext, "ShiftRightLogical(Vector256s<UInt16>.Demo, count):\t{0}", Avx2.ShiftRightLogical(Vector256s<UInt16>.Demo, count));
                WriteLine(tw, indentNext, "ShiftRightLogical(Vector256s<UInt32>.Demo, count):\t{0}", Avx2.ShiftRightLogical(Vector256s<UInt32>.Demo, count));
                WriteLine(tw, indentNext, "ShiftRightLogical(Vector256s<UInt64>.Demo, count):\t{0}", Avx2.ShiftRightLogical(Vector256s<UInt64>.Demo, count));
                WriteLine(tw, indentNext, "ShiftRightLogical(Vector256s<Int16>.Demo, count):\t{0}", Avx2.ShiftRightLogical(Vector256s<Int16>.Demo, count));
                WriteLine(tw, indentNext, "ShiftRightLogical(Vector256s<Int32>.Demo, count):\t{0}", Avx2.ShiftRightLogical(Vector256s<Int32>.Demo, count));
                WriteLine(tw, indentNext, "ShiftRightLogical(Vector256s<Int64>.Demo, count):\t{0}", Avx2.ShiftRightLogical(Vector256s<Int64>.Demo, count));
            }
            ...
            // VPSRLDQ ymm, ymm, imm8
            foreach (byte count in new byte[] { 1, 15 }) {
                WriteLine(tw, indent, "ShiftRightLogical128BitLane - count={0} (0x{0:X}):", count);
                WriteLine(tw, indentNext, "ShiftRightLogical128BitLane(Vector256s<Byte>.Demo, count):\t{0}", Avx2.ShiftRightLogical128BitLane(Vector256s<Byte>.Demo, count));
                WriteLine(tw, indentNext, "ShiftRightLogical128BitLane(Vector256s<UInt16>.Demo, count):\t{0}", Avx2.ShiftRightLogical128BitLane(Vector256s<UInt16>.Demo, count));
                WriteLine(tw, indentNext, "ShiftRightLogical128BitLane(Vector256s<UInt32>.Demo, count):\t{0}", Avx2.ShiftRightLogical128BitLane(Vector256s<UInt32>.Demo, count));
                WriteLine(tw, indentNext, "ShiftRightLogical128BitLane(Vector256s<UInt64>.Demo, count):\t{0}", Avx2.ShiftRightLogical128BitLane(Vector256s<UInt64>.Demo, count));
                WriteLine(tw, indentNext, "ShiftRightLogical128BitLane(Vector256s<SByte>.Demo, count):\t{0}", Avx2.ShiftRightLogical128BitLane(Vector256s<SByte>.Demo, count));
                WriteLine(tw, indentNext, "ShiftRightLogical128BitLane(Vector256s<Int16>.Demo, count):\t{0}", Avx2.ShiftRightLogical128BitLane(Vector256s<Int16>.Demo, count));
                WriteLine(tw, indentNext, "ShiftRightLogical128BitLane(Vector256s<Int32>.Demo, count):\t{0}", Avx2.ShiftRightLogical128BitLane(Vector256s<Int32>.Demo, count));
                WriteLine(tw, indentNext, "ShiftRightLogical128BitLane(Vector256s<Int64>.Demo, count):\t{0}", Avx2.ShiftRightLogical128BitLane(Vector256s<Int64>.Demo, count));
            }
            ...
            // VPSRLVQ ymm, ymm, ymm/m256
            WriteLine(tw, indent, "ShiftRightLogicalVariable(Vector128s<Int32>.V2, Vector128s<UInt32>.Serial):\t{0}", Avx2.ShiftRightLogicalVariable(Vector128s<Int32>.V2, Vector128s<UInt32>.Serial));
            WriteLine(tw, indent, "ShiftRightLogicalVariable(Vector256s<Int32>.V2, Vector256s<UInt32>.Serial):\t{0}", Avx2.ShiftRightLogicalVariable(Vector256s<Int32>.V2, Vector256s<UInt32>.Serial));
            WriteLine(tw, indent, "ShiftRightLogicalVariable(Vector256s<Int64>.V2, Vector256s<UInt64>.Serial):\t{0}", Avx2.ShiftRightLogicalVariable(Vector256s<Int64>.V2, Vector256s<UInt64>.Serial));
            WriteLine(tw, indent, "ShiftRightLogicalVariable(Vector256s<Int32>.Demo, Vector256s<UInt32>.Serial):\t{0}", Avx2.ShiftRightLogicalVariable(Vector256s<Int32>.Demo, Vector256s<UInt32>.Serial));
            ...
            // VPSHUFD ymm, ymm/m256, imm8
            WriteLine(tw, indent, "Shuffle(Vector256s<Byte>.Demo, Vector256s<Byte>.Serial):\t{0}", Avx2.Shuffle(Vector256s<Byte>.Demo, Vector256s<Byte>.Serial));
            WriteLine(tw, indent, "Shuffle(Vector256s<SByte>.Demo, Vector256s<SByte>.Serial):\t{0}", Avx2.Shuffle(Vector256s<SByte>.Demo, Vector256s<SByte>.Serial));
            // Shuffle int - control: Reverse order based on 128 bits.
            WriteLine(tw, indent, "Shuffle(Vector256s<Int32>.Demo, 0b0001_1011):\t{0}", Avx2.Shuffle(Vector256s<Int32>.Demo, 0b0001_1011));
            WriteLine(tw, indent, "Shuffle(Vector256s<UInt32>.Demo, 0b0001_1011):\t{0}", Avx2.Shuffle(Vector256s<UInt32>.Demo, 0b0001_1011));
            //Debugger.Break();
            ...
            WriteLine(tw, indent, "ShuffleHigh(Vector256s<Int16>.Demo, 0b0001_1011):\t{0}", Avx2.ShuffleHigh(Vector256s<Int16>.Demo, 0b0001_1011));
            ...
            WriteLine(tw, indent, "ShuffleLow(Vector256s<Int16>.Demo, 0b0001_1011):\t{0}", Avx2.ShuffleLow(Vector256s<Int16>.Demo, 0b0001_1011));
            ...
            WriteLine(tw, indent, "Sign(Vector256s<SByte>.Serial, Vector256s<SByte>.Demo):\t{0}", Avx2.Sign(Vector256s<SByte>.Serial, Vector256s<SByte>.Demo));
            WriteLine(tw, indent, "Sign(Vector256s<Int16>.Serial, Vector256s<Int16>.Demo):\t{0}", Avx2.Sign(Vector256s<Int16>.Serial, Vector256s<Int16>.Demo));
            WriteLine(tw, indent, "Sign(Vector256s<Int32>.Serial, Vector256s<Int32>.Demo):\t{0}", Avx2.Sign(Vector256s<Int32>.Serial, Vector256s<Int32>.Demo));
            ...
            // VPSUBQ ymm, ymm, ymm/m256
            WriteLine(tw, indent, "Subtract(Vector256s<Byte>.Demo, Vector256s<Byte>.V2):\t{0}", Avx2.Subtract(Vector256s<Byte>.Demo, Vector256s<Byte>.V2));
            WriteLine(tw, indent, "Subtract(Vector256s<UInt16>.Demo, Vector256s<UInt16>.V2):\t{0}", Avx2.Subtract(Vector256s<UInt16>.Demo, Vector256s<UInt16>.V2));
            WriteLine(tw, indent, "Subtract(Vector256s<UInt32>.Demo, Vector256s<UInt32>.V2):\t{0}", Avx2.Subtract(Vector256s<UInt32>.Demo, Vector256s<UInt32>.V2));
            WriteLine(tw, indent, "Subtract(Vector256s<UInt64>.Demo, Vector256s<UInt64>.V2):\t{0}", Avx2.Subtract(Vector256s<UInt64>.Demo, Vector256s<UInt64>.V2));
            WriteLine(tw, indent, "Subtract(Vector256s<SByte>.Demo, Vector256s<SByte>.V2):\t{0}", Avx2.Subtract(Vector256s<SByte>.Demo, Vector256s<SByte>.V2));
            WriteLine(tw, indent, "Subtract(Vector256s<Int16>.Demo, Vector256s<Int16>.V2):\t{0}", Avx2.Subtract(Vector256s<Int16>.Demo, Vector256s<Int16>.V2));
            WriteLine(tw, indent, "Subtract(Vector256s<Int32>.Demo, Vector256s<Int32>.V2):\t{0}", Avx2.Subtract(Vector256s<Int32>.Demo, Vector256s<Int32>.V2));
            WriteLine(tw, indent, "Subtract(Vector256s<Int64>.Demo, Vector256s<Int64>.V2):\t{0}", Avx2.Subtract(Vector256s<Int64>.Demo, Vector256s<Int64>.V2));
            ...
            WriteLine(tw, indent, "SubtractSaturate(Vector256s<Byte>.Demo, Vector256s<Byte>.V2):\t{0}", Avx2.SubtractSaturate(Vector256s<Byte>.Demo, Vector256s<Byte>.V2));
            WriteLine(tw, indent, "SubtractSaturate(Vector256s<UInt16>.Demo, Vector256s<UInt16>.V2):\t{0}", Avx2.SubtractSaturate(Vector256s<UInt16>.Demo, Vector256s<UInt16>.V2));
            WriteLine(tw, indent, "SubtractSaturate(Vector256s<SByte>.Demo, Vector256s<SByte>.V2):\t{0}", Avx2.SubtractSaturate(Vector256s<SByte>.Demo, Vector256s<SByte>.V2));
            WriteLine(tw, indent, "SubtractSaturate(Vector256s<Int16>.Demo, Vector256s<Int16>.V2):\t{0}", Avx2.SubtractSaturate(Vector256s<Int16>.Demo, Vector256s<Int16>.V2));
            ...
            // 	dst[i+63:i+16] := 0
            // ENDFOR
            WriteLine(tw, indent, "SumAbsoluteDifferences(Vector256s<Byte>.Demo, Vector256s<Byte>.V2):\t{0}", Avx2.SumAbsoluteDifferences(Vector256s<Byte>.Demo, Vector256s<Byte>.V2));
            WriteLine(tw, indent, "SumAbsoluteDifferences(Vector256s<Byte>.Serial, Vector256s<Byte>.V2):\t{0}", Avx2.SumAbsoluteDifferences(Vector256s<Byte>.Serial, Vector256s<Byte>.V2));
            ...
            // VPUNPCKHQDQ ymm, ymm, ymm/m256
            WriteLine(tw, indent, "UnpackHigh(Vector256s<Byte>.Demo, Vector256s<Byte>.V2):\t{0}", Avx2.UnpackHigh(Vector256s<Byte>.Demo, Vector256s<Byte>.V2));
            WriteLine(tw, indent, "UnpackHigh(Vector256s<UInt16>.Demo, Vector256s<UInt16>.V2):\t{0}", Avx2.UnpackHigh(Vector256s<UInt16>.Demo, Vector256s<UInt16>.V2));
            WriteLine(tw, indent, "UnpackHigh(Vector256s<UInt32>.Demo, Vector256s<UInt32>.V2):\t{0}", Avx2.UnpackHigh(Vector256s<UInt32>.Demo, Vector256s<UInt32>.V2));
            WriteLine(tw, indent, "UnpackHigh(Vector256s<UInt64>.Demo, Vector256s<UInt64>.V2):\t{0}", Avx2.UnpackHigh(Vector256s<UInt64>.Demo, Vector256s<UInt64>.V2));
            WriteLine(tw, indent, "UnpackHigh(Vector256s<SByte>.Demo, Vector256s<SByte>.V2):\t{0}", Avx2.UnpackHigh(Vector256s<SByte>.Demo, Vector256s<SByte>.V2));
            WriteLine(tw, indent, "UnpackHigh(Vector256s<Int16>.Demo, Vector256s<Int16>.V2):\t{0}", Avx2.UnpackHigh(Vector256s<Int16>.Demo, Vector256s<Int16>.V2));
            WriteLine(tw, indent, "UnpackHigh(Vector256s<Int32>.Demo, Vector256s<Int32>.V2):\t{0}", Avx2.UnpackHigh(Vector256s<Int32>.Demo, Vector256s<Int32>.V2));
            WriteLine(tw, indent, "UnpackHigh(Vector256s<Int64>.Demo, Vector256s<Int64>.V2):\t{0}", Avx2.UnpackHigh(Vector256s<Int64>.Demo, Vector256s<Int64>.V2));
            ...
            // VPUNPCKLQDQ ymm, ymm, ymm/m256
            WriteLine(tw, indent, "UnpackLow(Vector256s<Byte>.Demo, Vector256s<Byte>.V2):\t{0}", Avx2.UnpackLow(Vector256s<Byte>.Demo, Vector256s<Byte>.V2));
            WriteLine(tw, indent, "UnpackLow(Vector256s<UInt16>.Demo, Vector256s<UInt16>.V2):\t{0}", Avx2.UnpackLow(Vector256s<UInt16>.Demo, Vector256s<UInt16>.V2));
            WriteLine(tw, indent, "UnpackLow(Vector256s<UInt32>.Demo, Vector256s<UInt32>.V2):\t{0}", Avx2.UnpackLow(Vector256s<UInt32>.Demo, Vector256s<UInt32>.V2));
            WriteLine(tw, indent, "UnpackLow(Vector256s<UInt64>.Demo, Vector256s<UInt64>.V2):\t{0}", Avx2.UnpackLow(Vector256s<UInt64>.Demo, Vector256s<UInt64>.V2));
            WriteLine(tw, indent, "UnpackLow(Vector256s<SByte>.Demo, Vector256s<SByte>.V2):\t{0}", Avx2.UnpackLow(Vector256s<SByte>.Demo, Vector256s<SByte>.V2));
            WriteLine(tw, indent, "UnpackLow(Vector256s<Int16>.Demo, Vector256s<Int16>.V2):\t{0}", Avx2.UnpackLow(Vector256s<Int16>.Demo, Vector256s<Int16>.V2));
            WriteLine(tw, indent, "UnpackLow(Vector256s<Int32>.Demo, Vector256s<Int32>.V2):\t{0}", Avx2.UnpackLow(Vector256s<Int32>.Demo, Vector256s<Int32>.V2));
            WriteLine(tw, indent, "UnpackLow(Vector256s<Int64>.Demo, Vector256s<Int64>.V2):\t{0}", Avx2.UnpackLow(Vector256s<Int64>.Demo, Vector256s<Int64>.V2));
            ...
            // VPXOR ymm, ymm, ymm/m256
            WriteLine(tw, indent, "Xor(Vector256s<Byte>.Demo, Vector256s<Byte>.V2):\t{0}", Avx2.Xor(Vector256s<Byte>.Demo, Vector256s<Byte>.V2));
            WriteLine(tw, indent, "Xor(Vector256s<UInt16>.Demo, Vector256s<UInt16>.V2):\t{0}", Avx2.Xor(Vector256s<UInt16>.Demo, Vector256s<UInt16>.V2));
            WriteLine(tw, indent, "Xor(Vector256s<UInt32>.Demo, Vector256s<UInt32>.V2):\t{0}", Avx2.Xor(Vector256s<UInt32>.Demo, Vector256s<UInt32>.V2));
            WriteLine(tw, indent, "Xor(Vector256s<UInt64>.Demo, Vector256s<UInt64>.V2):\t{0}", Avx2.Xor(Vector256s<UInt64>.Demo, Vector256s<UInt64>.V2));
            WriteLine(tw, indent, "Xor(Vector256s<SByte>.Demo, Vector256s<SByte>.V2):\t{0}", Avx2.Xor(Vector256s<SByte>.Demo, Vector256s<SByte>.V2));
            WriteLine(tw, indent, "Xor(Vector256s<Int16>.Demo, Vector256s<Int16>.V2):\t{0}", Avx2.Xor(Vector256s<Int16>.Demo, Vector256s<Int16>.V2));
            WriteLine(tw, indent, "Xor(Vector256s<Int32>.Demo, Vector256s<Int32>.V2):\t{0}", Avx2.Xor(Vector256s<Int32>.Demo, Vector256s<Int32>.V2));
            WriteLine(tw, indent, "Xor(Vector256s<Int64>.Demo, Vector256s<Int64>.V2):\t{0}", Avx2.Xor(Vector256s<Int64>.Demo, Vector256s<Int64>.V2));
        ...
        public static void RunX86Fma(TextWriter tw, string indent) {
            ...
            WriteLine(tw, indent, "MultiplyAdd(Vector128s<Double>.Serial, Vector128s<Double>.V2, Vector128s<Double>.V1):\t{0}", Fma.MultiplyAdd(Vector128s<Double>.Serial, Vector128s<Double>.V2, Vector128s<Double>.V1));
            WriteLine(tw, indent, "MultiplyAdd(Vector128s<Single>.Serial, Vector128s<Single>.V2, Vector128s<Single>.V1):\t{0}", Fma.MultiplyAdd(Vector128s<Single>.Serial, Vector128s<Single>.V2, Vector128s<Single>.V1));
            WriteLine(tw, indent, "MultiplyAdd(Vector256s<Double>.Serial, Vector256s<Double>.V2, Vector256s<Double>.V1):\t{0}", Fma.MultiplyAdd(Vector256s<Double>.Serial, Vector256s<Double>.V2, Vector256s<Double>.V1));
            WriteLine(tw, indent, "MultiplyAdd(Vector256s<Single>.Serial, Vector256s<Single>.V2, Vector256s<Single>.V1):\t{0}", Fma.MultiplyAdd(Vector256s<Single>.Serial, Vector256s<Single>.V2, Vector256s<Single>.V1));
            ...
            WriteLine(tw, indent, "MultiplyAddNegated(Vector128s<Double>.Serial, Vector128s<Double>.V2, Vector128s<Double>.V1):\t{0}", Fma.MultiplyAddNegated(Vector128s<Double>.Serial, Vector128s<Double>.V2, Vector128s<Double>.V1));
            WriteLine(tw, indent, "MultiplyAddNegated(Vector128s<Single>.Serial, Vector128s<Single>.V2, Vector128s<Single>.V1):\t{0}", Fma.MultiplyAddNegated(Vector128s<Single>.Serial, Vector128s<Single>.V2, Vector128s<Single>.V1));
            WriteLine(tw, indent, "MultiplyAddNegated(Vector256s<Double>.Serial, Vector256s<Double>.V2, Vector256s<Double>.V1):\t{0}", Fma.MultiplyAddNegated(Vector256s<Double>.Serial, Vector256s<Double>.V2, Vector256s<Double>.V1));
            WriteLine(tw, indent, "MultiplyAddNegated(Vector256s<Single>.Serial, Vector256s<Single>.V2, Vector256s<Single>.V1):\t{0}", Fma.MultiplyAddNegated(Vector256s<Single>.Serial, Vector256s<Single>.V2, Vector256s<Single>.V1));
            ...
            // dst[127:32] := a[127:32]
            WriteLine(tw, indent, "MultiplyAddNegatedScalar(Vector128s<Double>.Serial, Vector128s<Double>.V2, Vector128s<Double>.V1):\t{0}", Fma.MultiplyAddNegatedScalar(Vector128s<Double>.Serial, Vector128s<Double>.V2, Vector128s<Double>.V1));
            WriteLine(tw, indent, "MultiplyAddNegatedScalar(Vector128s<Single>.Serial, Vector128s<Single>.V2, Vector128s<Single>.V1):\t{0}", Fma.MultiplyAddNegatedScalar(Vector128s<Single>.Serial, Vector128s<Single>.V2, Vector128s<Single>.V1));
            ...
            WriteLine(tw, indent, "MultiplyAddScalar(Vector128s<Double>.Serial, Vector128s<Double>.V2, Vector128s<Double>.V1):\t{0}", Fma.MultiplyAddScalar(Vector128s<Double>.Serial, Vector128s<Double>.V2, Vector128s<Double>.V1));
            WriteLine(tw, indent, "MultiplyAddScalar(Vector128s<Single>.Serial, Vector128s<Single>.V2, Vector128s<Single>.V1):\t{0}", Fma.MultiplyAddScalar(Vector128s<Single>.Serial, Vector128s<Single>.V2, Vector128s<Single>.V1));
            ...
            WriteLine(tw, indent, "MultiplyAddSubtract(Vector128s<Double>.Serial, Vector128s<Double>.V2, Vector128s<Double>.V1):\t{0}", Fma.MultiplyAddSubtract(Vector128s<Double>.Serial, Vector128s<Double>.V2, Vector128s<Double>.V1));
            WriteLine(tw, indent, "MultiplyAddSubtract(Vector128s<Single>.Serial, Vector128s<Single>.V2, Vector128s<Single>.V1):\t{0}", Fma.MultiplyAddSubtract(Vector128s<Single>.Serial, Vector128s<Single>.V2, Vector128s<Single>.V1));
            WriteLine(tw, indent, "MultiplyAddSubtract(Vector256s<Double>.Serial, Vector256s<Double>.V2, Vector256s<Double>.V1):\t{0}", Fma.MultiplyAddSubtract(Vector256s<Double>.Serial, Vector256s<Double>.V2, Vector256s<Double>.V1));
            WriteLine(tw, indent, "MultiplyAddSubtract(Vector256s<Single>.Serial, Vector256s<Single>.V2, Vector256s<Single>.V1):\t{0}", Fma.MultiplyAddSubtract(Vector256s<Single>.Serial, Vector256s<Single>.V2, Vector256s<Single>.V1));
            ...
            WriteLine(tw, indent, "MultiplySubtract(Vector128s<Double>.Serial, Vector128s<Double>.V2, Vector128s<Double>.V1):\t{0}", Fma.MultiplySubtract(Vector128s<Double>.Serial, Vector128s<Double>.V2, Vector128s<Double>.V1));
            WriteLine(tw, indent, "MultiplySubtract(Vector128s<Single>.Serial, Vector128s<Single>.V2, Vector128s<Single>.V1):\t{0}", Fma.MultiplySubtract(Vector128s<Single>.Serial, Vector128s<Single>.V2, Vector128s<Single>.V1));
            WriteLine(tw, indent, "MultiplySubtract(Vector256s<Double>.Serial, Vector256s<Double>.V2, Vector256s<Double>.V1):\t{0}", Fma.MultiplySubtract(Vector256s<Double>.Serial, Vector256s<Double>.V2, Vector256s<Double>.V1));
            WriteLine(tw, indent, "MultiplySubtract(Vector256s<Single>.Serial, Vector256s<Single>.V2, Vector256s<Single>.V1):\t{0}", Fma.MultiplySubtract(Vector256s<Single>.Serial, Vector256s<Single>.V2, Vector256s<Single>.V1));
            ...
            WriteLine(tw, indent, "MultiplySubtractAdd(Vector128s<Double>.Serial, Vector128s<Double>.V2, Vector128s<Double>.V1):\t{0}", Fma.MultiplySubtractAdd(Vector128s<Double>.Serial, Vector128s<Double>.V2, Vector128s<Double>.V1));
            WriteLine(tw, indent, "MultiplySubtractAdd(Vector128s<Single>.Serial, Vector128s<Single>.V2, Vector128s<Single>.V1):\t{0}", Fma.MultiplySubtractAdd(Vector128s<Single>.Serial, Vector128s<Single>.V2, Vector128s<Single>.V1));
            WriteLine(tw, indent, "MultiplySubtractAdd(Vector256s<Double>.Serial, Vector256s<Double>.V2, Vector256s<Double>.V1):\t{0}", Fma.MultiplySubtractAdd(Vector256s<Double>.Serial, Vector256s<Double>.V2, Vector256s<Double>.V1));
            WriteLine(tw, indent, "MultiplySubtractAdd(Vector256s<Single>.Serial, Vector256s<Single>.V2, Vector256s<Single>.V1):\t{0}", Fma.MultiplySubtractAdd(Vector256s<Single>.Serial, Vector256s<Single>.V2, Vector256s<Single>.V1));
            ...
            WriteLine(tw, indent, "MultiplySubtractNegated(Vector128s<Double>.Serial, Vector128s<Double>.V2, Vector128s<Double>.V1):\t{0}", Fma.MultiplySubtractNegated(Vector128s<Double>.Serial, Vector128s<Double>.V2, Vector128s<Double>.V1));
            WriteLine(tw, indent, "MultiplySubtractNegated(Vector128s<Single>.Serial, Vector128s<Single>.V2, Vector128s<Single>.V1):\t{0}", Fma.MultiplySubtractNegated(Vector128s<Single>.Serial, Vector128s<Single>.V2, Vector128s<Single>.V1));
            WriteLine(tw, indent, "MultiplySubtractNegated(Vector256s<Double>.Serial, Vector256s<Double>.V2, Vector256s<Double>.V1):\t{0}", Fma.MultiplySubtractNegated(Vector256s<Double>.Serial, Vector256s<Double>.V2, Vector256s<Double>.V1));
            WriteLine(tw, indent, "MultiplySubtractNegated(Vector256s<Single>.Serial, Vector256s<Single>.V2, Vector256s<Single>.V1):\t{0}", Fma.MultiplySubtractNegated(Vector256s<Single>.Serial, Vector256s<Single>.V2, Vector256s<Single>.V1));
            ...
            WriteLine(tw, indent, "MultiplySubtractNegatedScalar(Vector128s<Double>.Serial, Vector128s<Double>.V2, Vector128s<Double>.V1):\t{0}", Fma.MultiplySubtractNegatedScalar(Vector128s<Double>.Serial, Vector128s<Double>.V2, Vector128s<Double>.V1));
            WriteLine(tw, indent, "MultiplySubtractNegatedScalar(Vector128s<Single>.Serial, Vector128s<Single>.V2, Vector128s<Single>.V1):\t{0}", Fma.MultiplySubtractNegatedScalar(Vector128s<Single>.Serial, Vector128s<Single>.V2, Vector128s<Single>.V1));
            ...
            WriteLine(tw, indent, "MultiplySubtractScalar(Vector128s<Double>.Serial, Vector128s<Double>.V2, Vector128s<Double>.V1):\t{0}", Fma.MultiplySubtractScalar(Vector128s<Double>.Serial, Vector128s<Double>.V2, Vector128s<Double>.V1));
            WriteLine(tw, indent, "MultiplySubtractScalar(Vector128s<Single>.Serial, Vector128s<Single>.V2, Vector128s<Single>.V1):\t{0}", Fma.MultiplySubtractScalar(Vector128s<Single>.Serial, Vector128s<Single>.V2, Vector128s<Single>.V1));
        ...
        public static void RunX86AvxVnni(TextWriter tw, string indent) {
            ...
            WriteLine(tw, indent, "MultiplyWideningAndAdd(Vector128s<Int32>.V1, Vector128s<Byte>.Serial, Vector128s<SByte>.V2):\t{0}", AvxVnni.MultiplyWideningAndAdd(Vector128s<Int32>.V1, Vector128s<Byte>.Serial, Vector128s<SByte>.V2));
            WriteLine(tw, indent, "MultiplyWideningAndAdd(Vector128s<Int32>.V1, Vector128s<Int16>.Serial, Vector128s<Int16>.V2):\t{0}", AvxVnni.MultiplyWideningAndAdd(Vector128s<Int32>.V1, Vector128s<Int16>.Serial, Vector128s<Int16>.V2));
            WriteLine(tw, indent, "MultiplyWideningAndAdd(Vector256s<Int32>.V1, Vector256s<Byte>.Serial, Vector256s<SByte>.V2):\t{0}", AvxVnni.MultiplyWideningAndAdd(Vector256s<Int32>.V1, Vector256s<Byte>.Serial, Vector256s<SByte>.V2));
            WriteLine(tw, indent, "MultiplyWideningAndAdd(Vector256s<Int32>.V1, Vector256s<Int16>.Serial, Vector256s<Int16>.V2):\t{0}", AvxVnni.MultiplyWideningAndAdd(Vector256s<Int32>.V1, Vector256s<Int16>.Serial, Vector256s<Int16>.V2));
            ...
            WriteLine(tw, indent, "MultiplyWideningAndAddSaturate(Vector128s<Int32>.V1, Vector128s<Byte>.Serial, Vector128s<SByte>.V2):\t{0}", AvxVnni.MultiplyWideningAndAddSaturate(Vector128s<Int32>.V1, Vector128s<Byte>.Serial, Vector128s<SByte>.V2));
            WriteLine(tw, indent, "MultiplyWideningAndAddSaturate(Vector128s<Int32>.V1, Vector128s<Int16>.Serial, Vector128s<Int16>.V2):\t{0}", AvxVnni.MultiplyWideningAndAddSaturate(Vector128s<Int32>.V1, Vector128s<Int16>.Serial, Vector128s<Int16>.V2));
            WriteLine(tw, indent, "MultiplyWideningAndAddSaturate(Vector256s<Int32>.V1, Vector256s<Byte>.Serial, Vector256s<SByte>.V2):\t{0}", AvxVnni.MultiplyWideningAndAddSaturate(Vector256s<Int32>.V1, Vector256s<Byte>.Serial, Vector256s<SByte>.V2));
            WriteLine(tw, indent, "MultiplyWideningAndAddSaturate(Vector256s<Int32>.V1, Vector256s<Int16>.Serial, Vector256s<Int16>.V2):\t{0}", AvxVnni.MultiplyWideningAndAddSaturate(Vector256s<Int32>.V1, Vector256s<Int16>.Serial, Vector256s<Int16>.V2));
