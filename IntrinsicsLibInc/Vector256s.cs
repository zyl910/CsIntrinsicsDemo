...
namespace IntrinsicsLib {
    ...
    public abstract class Vector256s<T> : AbstractVectors<T> where T : struct {
        ...
        static Vector256s() {
            ...
            // -- Mask --
            MaskBits1 = Vector256s.Create<T>(ElementMaskBits1);
            MaskBits2 = Vector256s.Create<T>(ElementMaskBits2);
            MaskBits4 = Vector256s.Create<T>(ElementMaskBits4);
            MaskBits8 = Vector256s.Create<T>(ElementMaskBits8);
            MaskBits16 = Vector256s.Create<T>(ElementMaskBits16);
            MaskBits32 = Vector256s.Create<T>(ElementMaskBits32);
            // -- Positive number --
            ...
            V127 = Vector256s.Create<T>(ElementV127);
            V255 = Vector256s.Create<T>(ElementV255);
            V32767 = Vector256s.Create<T>(ElementV32767);
            V65535 = Vector256s.Create<T>(ElementV65535);
            V2147483647 = Vector256s.Create<T>(ElementV2147483647);
            V4294967295 = Vector256s.Create<T>(ElementV4294967295);
            // -- Negative number  --
        ...
        public static ref readonly Vector256<T> XyNotXMask { get { return ref XyYMask; } }
        /// <summary>Xy - Not Y mask. For a 2-element group, not select the mask of the 1st element (对于2个元素的组，不选择第1个元素的掩码).</summary>
        public static ref readonly Vector256<T> XyNotYMask { get { return ref XyXMask; } }
        ...
        public static ref readonly Vector256<T> RgbaRMask { get { return ref XyzwXMask; } }
        ...
        public static ref readonly Vector256<T> RgbaGMask { get { return ref XyzwYMask; } }
        ...
        public static ref readonly Vector256<T> RgbaBMask { get { return ref XyzwZMask; } }
        ...
        public static ref readonly Vector256<T> RgbaAMask { get { return ref XyzwWMask; } }
        ...
        public static ref readonly Vector256<T> RgbaNotRMask { get { return ref XyzwNotXMask; } }
        ...
        public static ref readonly Vector256<T> RgbaNotGMask { get { return ref XyzwNotYMask; } }
        ...
        public static ref readonly Vector256<T> RgbaNotBMask { get { return ref XyzwNotZMask; } }
        ...
        public static ref readonly Vector256<T> RgbaNotAMask { get { return ref XyzwNotWMask; } }
