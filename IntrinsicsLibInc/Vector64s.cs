...
namespace IntrinsicsLib {
    ...
    public static class Vector64s {
        ...
        /// <summary>
        /// Rotate creates a new <see cref="Vector64{T}"/> from a given array starting at a specified index position (于指定索引位置开始，从指定数组旋转创建一个 <see cref="Vector64{T}"/>).
        /// </summary>
        /// <typeparam name="T">The vector element type (向量中的元素的类型).</typeparam>
        /// <param name="values">The array from which the vector is created (用于创建向量的数组).</param>
        /// <param name="index">The starting index position from which to create the vector (欲创建向量的起始索引位置).</param>
    ...
    public abstract class Vector64s<T> : AbstractVectors<T> where T : struct {
        ...
        static Vector64s() {
            ...
            // -- Mask --
            MaskBits1 = Vector64s.Create<T>(ElementMaskBits1);
            MaskBits2 = Vector64s.Create<T>(ElementMaskBits2);
            MaskBits4 = Vector64s.Create<T>(ElementMaskBits4);
            MaskBits8 = Vector64s.Create<T>(ElementMaskBits8);
            MaskBits16 = Vector64s.Create<T>(ElementMaskBits16);
            MaskBits32 = Vector64s.Create<T>(ElementMaskBits32);
            // -- Positive number --
            ...
            V127 = Vector64s.Create<T>(ElementV127);
            V255 = Vector64s.Create<T>(ElementV255);
            V32767 = Vector64s.Create<T>(ElementV32767);
            V65535 = Vector64s.Create<T>(ElementV65535);
            V2147483647 = Vector64s.Create<T>(ElementV2147483647);
            V4294967295 = Vector64s.Create<T>(ElementV4294967295);
            // -- Negative number  --
            ...
            V_128 = Vector64s.Create<T>(ElementV_128);
            V_32768 = Vector64s.Create<T>(ElementV_32768);
            V_2147483648 = Vector64s.Create<T>(ElementV_2147483648);
            // -- Specified value --
        ...
        public static ref readonly Vector64<T> XyNotXMask { get { return ref XyYMask; } }
        /// <summary>Xy - Not Y mask. For a 2-element group, not select the mask of the 1st element (对于2个元素的组，不选择第1个元素的掩码).</summary>
        public static ref readonly Vector64<T> XyNotYMask { get { return ref XyXMask; } }
        ...
        public static ref readonly Vector64<T> RgbaRMask { get { return ref XyzwXMask; } }
        ...
        public static ref readonly Vector64<T> RgbaGMask { get { return ref XyzwYMask; } }
        ...
        public static ref readonly Vector64<T> RgbaBMask { get { return ref XyzwZMask; } }
        ...
        public static ref readonly Vector64<T> RgbaAMask { get { return ref XyzwWMask; } }
        ...
        public static ref readonly Vector64<T> RgbaNotRMask { get { return ref XyzwNotXMask; } }
        ...
        public static ref readonly Vector64<T> RgbaNotGMask { get { return ref XyzwNotYMask; } }
        ...
        public static ref readonly Vector64<T> RgbaNotBMask { get { return ref XyzwNotZMask; } }
        ...
        public static ref readonly Vector64<T> RgbaNotAMask { get { return ref XyzwNotWMask; } }
